...
class AppStrings {
  ...
  /// Which primary theme the royal dresses, shown on the description sheet.
  String royalHomeNote(bool dressesLight) => dressesLight
      ? _t(
          'Graces the Light theme — effects appear while Light is active.',
          'लाइट थीम की शोभा — प्रभाव लाइट थीम सक्रिय रहते दिखते हैं।',
          'लाइट थीमची शोभा — लाइट थीम सक्रिय असताना प्रभाव दिसतात.',
          'লাইট থিমের শোভা — লাইট থিম সক্রিয় থাকলে প্রভাব দেখা যায়।',
          'లైట్ థీమ్‌కు శోభ — లైట్ థీమ్ యాక్టివ్‌గా ఉన్నప్పుడు ప్రభావాలు కనిపిస్తాయి.',
          'லைட் தீமின் அலங்காரம் — லைட் தீம் இயங்கும்போது விளைவுகள் தெரியும்.',
        )
      : _t(
          'Rules the Dark theme — effects appear while Dark is active.',
          'डार्क थीम पर राज — प्रभाव डार्क थीम सक्रिय रहते दिखते हैं।',
          'डार्क थीमवर राज्य — डार्क थीम सक्रिय असताना प्रभाव दिसतात.',
          'ডার্ক থিমে রাজত্ব — ডার্ক থিম সক্রিয় থাকলে প্রভাব দেখা যায়।',
          'డార్క్ థీమ్‌పై పాలన — డార్క్ థీమ్ యాక్టివ్‌గా ఉన్నప్పుడు ప్రభావాలు కనిపిస్తాయి.',
          'டார்க் தீமின் ஆட்சி — டார்க் தீம் இயங்கும்போது விளைவுகள் தெரியும்.',
        );

  /// Offer to switch the app to the royal's home theme so the dress shows.
  String royalSwitchMode(bool toLight) => toLight
      ? _t('Switch to Light theme now', 'अभी लाइट थीम पर जाएँ',
          'आता लाइट थीमवर जा', 'এখনই লাইট থিমে যান',
          'ఇప్పుడు లైట్ థీమ్‌కు మారండి', 'இப்போது லைட் தீமிற்கு மாறவும்')
      : _t('Switch to Dark theme now', 'अभी डार्क थीम पर जाएँ',
          'आता डार्क थीमवर जा', 'এখনই ডার্ক থিমে যান',
          'ఇప్పుడు డార్క్ థీమ్‌కు మారండి', 'இப்போது டார்க் தீமிற்கு மாறவும்');
  String get royalOnHomeTheme => _t("You're on its theme — effects are live",
      'आप इसकी थीम पर हैं — प्रभाव सक्रिय हैं',
      'तुम्ही याच्या थीमवर आहात — प्रभाव सक्रिय आहेत',
      'আপনি এর থিমে আছেন — প্রভাব সক্রিয়',
      'మీరు దీని థీమ్‌లో ఉన్నారు — ప్రభావాలు ప్రత్యక్షం',
      'நீங்கள் இதன் தீமில் உள்ளீர்கள் — விளைவுகள் இயங்குகின்றன');
