...
class AppStrings {
  ...
  String royalAvatarLore(String id) {
    switch (id) {
      ...
      case 'prince':
        return _t(
          'The heir in gilded plate, lance in hand — radiant, eager, golden.',
          'स्वर्ण कवच में उत्तराधिकारी, हाथ में भाला — तेजस्वी, उत्सुक, सुनहरा।',
          'सोनेरी चिलखतातील वारस, हाती भाला — तेजस्वी, उत्सुक, सुवर्ण.',
          'সোনালি বর্মে উত্তরাধিকারী, হাতে বর্শা — দীপ্তিমান, আগ্রহী, সোনালি।',
          'బంగారు కవచంలో వారసుడు, చేతిలో ఈటె — ప్రకాశవంతం, ఉత్సాహం, స్వర్ణం.',
          'பொன் கவசத்தில் வாரிசு, கையில் ஈட்டி — ஒளிரும், ஆர்வம், தங்கம்.',
        );
      case 'darkprince':
        return _t(
