...
class AppStrings {
  ...
  String get payerLabel => _t('Received from', 'प्रेषक', 'प्रेषक', 'প্রেরক', 'పంపినవారు', 'அனுப்புநர்');
  ...
  String get eliteAvatarsDesc => _t(
        'Legendary characters, earned only by the rarest badges.',
        'महान किरदार, जो केवल दुर्लभतम बैज से मिलते हैं।',
        'दिग्गज पात्रे, फक्त दुर्मीळ बॅजनेच मिळतात.',
        'কিংবদন্তি চরিত্র, শুধুমাত্র বিরলতম ব্যাজ দিয়েই অর্জনযোগ্য।',
        'అత్యంత అరుదైన బ్యాడ్జ్‌లతో మాత్రమే లభించే లెజెండరీ పాత్రలు.',
        'அரிதான பேட்ஜ்களால் மட்டுமே கிடைக்கும் லெஜண்டரி கதாபாத்திரங்கள்.',
      );
  ...
  /// How to unlock a locked elite avatar (mirrors kEliteAvatars badge gates).
  String eliteAvatarLock(String id) {
    switch (id) {
      case 'shadowblade':
        return _t(
          'Reach a 365-day streak to unlock.',
          '365 दिन की स्ट्रीक पर पहुँचकर अनलॉक करें।',
          '365 दिवसांची स्ट्रीक गाठून अनलॉक करा.',
          'আনলক করতে 365 দিনের স্ট্রিকে পৌঁছান।',
          'అన్‌లాక్ చేయడానికి 365-రోజుల స్ట్రీక్ చేరుకోండి.',
          'திறக்க 365-நாள் ஸ்ட்ரீக்கை அடையுங்கள்.',
        );
      case 'crimsononi':
        return _t(
          'Finish 12 months within budget to unlock.',
          'बजट के भीतर 12 महीने पूरे कर अनलॉक करें।',
          'बजेटमध्ये राहून 12 महिने पूर्ण करून अनलॉक करा.',
          'আনলক করতে বাজেটের মধ্যে 12 মাস শেষ করুন।',
          'అన్‌లాక్ చేయడానికి బడ్జెట్‌లోపు 12 నెలలు పూర్తి చేయండి.',
          'திறக்க பட்ஜெட்டுக்குள் 12 மாதங்களை முடியுங்கள்.',
        );
      case 'cyberronin':
        return _t(
          'Track 8,000 transactions to unlock.',
          '8,000 लेनदेन ट्रैक कर अनलॉक करें।',
          '8,000 व्यवहार ट्रॅक करून अनलॉक करा.',
          'আনলক করতে 8,000টি লেনদেন ট্র্যাক করুন।',
          'అన్‌లాక్ చేయడానికి 8,000 లావాదేవీలు ట్రాక్ చేయండి.',
          'திறக்க 8,000 பரிவர்த்தனைகளை டிராக் செய்யுங்கள்.',
        );
      case 'dragonlord':
        return _t(
          'Track ₹50L of money moved to unlock.',
          '₹50 लाख की रकम ट्रैक कर अनलॉक करें।',
          '₹50 लाख रक्कम ट्रॅक करून अनलॉक करा.',
          'আনলক করতে ₹50 লাখ অর্থ ট্র্যাক করুন।',
          'అన్‌లాక్ చేయడానికి ₹50 లక్షల మొత్తాన్ని ట్రాక్ చేయండి.',
          'திறக்க ₹50 லட்சம் தொகையை டிராக் செய்யுங்கள்.',
        );
      case 'voidmonarch':
        return _t(
          'Reach a ₹1Cr net worth to unlock.',
          '₹1 करोड़ नेट वर्थ पर पहुँचकर अनलॉक करें।',
          '₹1 कोटी नेट वर्थ गाठून अनलॉक करा.',
          'আনলক করতে ₹1 কোটি নেট ওয়ার্থে পৌঁছান।',
          'అన్‌లాక్ చేయడానికి ₹1 కోటి నికర విలువ చేరుకోండి.',
          'திறக்க ₹1 கோடி நிகர மதிப்பை அடையுங்கள்.',
        );
      case 'phoenix':
        return _t(
          'Reach a 730-day streak to unlock.',
          '730 दिन की स्ट्रीक पर पहुँचकर अनलॉक करें।',
          '730 दिवसांची स्ट्रीक गाठून अनलॉक करा.',
          'আনলক করতে 730 দিনের স্ট্রিকে পৌঁছান।',
          'అన్‌లాక్ చేయడానికి 730-రోజుల స్ట్రీక్ చేరుకోండి.',
          'திறக்க 730-நாள் ஸ்ட்ரீக்கை அடையுங்கள்.',
        );
      default:
        return '';
    }
