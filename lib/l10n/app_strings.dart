...
class AppStrings {
  ...
  String streakRewardsUnlocked(int n, int total) => _t(
        '$n of $total rewards unlocked',
        '$total में से $n रिवॉर्ड अनलॉक',
        '$total पैकी $n रिवॉर्ड अनलॉक',
        '$total টির মধ্যে $n রিওয়ার্ড আনলক',
        '$total లో $n రివార్డ్‌లు అన్‌లాక్ అయ్యాయి',
        '$total இல் $n வெகுமதிகள் திறக்கப்பட்டன',
      );
  ...
  // ── Review queue & parser corrections ─────────────────────────────────
  String get needsReviewBadge =>
      _t('Check', 'जांचें', 'तपासा', 'যাচাই', 'తనిఖీ', 'சரிபார்');
  String get needsReviewFilter => _t('Needs review', 'समीक्षा ज़रूरी',
      'तपासणी आवश्यक', 'পর্যালোচনা প্রয়োজন', 'సమీక్ష అవసరం', 'மதிப்பாய்வு தேவை');
  String get needsReviewTitle => _t(
        'Needs a quick check',
        'एक त्वरित जांच ज़रूरी',
        'एक झटपट तपासणी आवश्यक',
        'একটি দ্রুত যাচাই প্রয়োজন',
        'త్వరిత తనిఖీ అవసరం',
        'விரைவான சரிபார்ப்பு தேவை',
      );
  ...
  String get reviewReasonUnknownSender => _t(
        ...
        'हा प्रेषक अजून आमच्या बँक यादीत नाही',
        'এই প্রেরক এখনও আমাদের পরিচিত ব্যাংক নয়',
        'ఈ పంపినవారు ఇంకా మాకు తెలిసిన బ్యాంక్ కాదు',
        'இந்த அனுப்புநர் இன்னும் எங்களுக்குத் தெரிந்த வங்கி இல்லை',
      );
  String get reviewReasonPayeeUnknown => _t(
        "The SMS didn't name the other party",
        'SMS में सामने वाले का नाम नहीं था',
        'SMS मध्ये समोरच्याचे नाव नव्हते',
        'SMS-এ অন্য পক্ষের নাম ছিল না',
        'SMSలో అవతలి వ్యక్తి పేరు లేదు',
        'SMSஇல் மறு தரப்பின் பெயர் இல்லை',
      );
  String get reviewReasonDirection => _t(
        'Debit or credit was a close call',
        'डेबिट या क्रेडिट का अंदाज़ा लगाना पड़ा',
        'डेबिट की क्रेडिट याचा अंदाज बांधावा लागला',
        'ডেবিট না ক্রেডিট, অনুমান করতে হয়েছে',
        'డెబిట్ లేదా క్రెడిట్ అంచనా వేయాల్సి వచ్చింది',
        'பற்று அல்லது வரவு என்பதை யூகிக்க வேண்டியிருந்தது',
      );
  String get reviewReasonAmount => _t(
        'Several amounts appeared in this SMS',
        'इस SMS में कई राशियाँ थीं',
        'या SMS मध्ये अनेक रकमा होत्या',
        'এই SMS-এ একাধিক টাকার অঙ্ক ছিল',
        'ఈ SMSలో అనేక మొత్తాలు ఉన్నాయి',
        'இந்த SMSஇல் பல தொகைகள் இருந்தன',
      );
  String get readBy =>
      _t('Read by', 'पढ़ा गया', 'वाचले', 'পড়া হয়েছে', 'చదివినది', 'படித்தது');
  String get notATransaction => _t(
        'Not a transaction',
        'यह लेन-देन नहीं है',
        'हा व्यवहार नाही',
        'এটি লেনদেন নয়',
  ...
  String get notATransactionTagline => _t(
        'Remove this entry — it never comes back',
        'यह प्रविष्टि हटाएँ — यह फिर कभी नहीं आएगी',
        'ही नोंद काढा — ती पुन्हा कधीही येणार नाही',
        'এই এন্ট্রি সরান — এটি আর ফিরবে না',
        'ఈ ఎంట్రీని తీసివేయండి — ఇది మళ్ళీ రాదు',
        'இந்தப் பதிவை நீக்கு — இது மீண்டும் வராது',
      );
  String get ignoreSimilarMessages => _t(
        'Also ignore similar messages from this sender',
        'इस भेजने वाले के ऐसे संदेश आगे भी अनदेखा करें',
        'या प्रेषकाचे असे संदेश पुढेही दुर्लक्षित करा',
        'এই প্রেরকের এমন বার্তা ভবিষ্যতেও উপেক্ষা করুন',
        'ఈ పంపినవారి ఇలాంటి సందేశాలను ఇకపైనా విస్మరించండి',
        'இந்த அனுப்புநரின் இதுபோன்ற செய்திகளை இனியும் புறக்கணி',
      );
  String get ignoredMessages => _t(
        'Ignored messages',
        'अनदेखे संदेश',
        'दुर्लक्षित संदेश',
        'উপেক্ষিত বার্তা',
        'విస్మరించిన సందేశాలు',
        'புறக்கணிக்கப்பட்ட செய்திகள்',
      );
  String get ignoredMessagesTagline => _t(
        'Message shapes you told the app to skip',
        'ऐसे संदेश जिन्हें छोड़ने को आपने कहा',
        'तुम्ही वगळायला सांगितलेले संदेश',
        'যে বার্তাগুলি বাদ দিতে বলেছেন',
        'దాటవేయమని మీరు చెప్పిన సందేశాలు',
        'தவிர்க்கச் சொன்ன செய்திகள்',
      );
  String get noIgnoredMessages => _t(
        'Nothing ignored yet',
        'अभी कुछ भी अनदेखा नहीं',
        'अजून काहीही दुर्लक्षित नाही',
        'এখনও কিছু উপেক্ষা করা হয়নি',
  ...
  String get changeToCredit => _t(
        ...
        'क्रेडिटमध्ये बदला',
        'ক্রেডিটে বদলান',
        'క్రెడిట్‌గా మార్చండి',
        'வரவாக மாற்று',
      );
  String get changeToDebit => _t(
        'Change to debit',
        'डेबिट में बदलें',
        'डेबिटमध्ये बदला',
        'ডেবিটে বদলান',
  ...
  String get changeTypeTagline => _t(
        'Fix the direction — the app remembers this SMS shape',
        'दिशा सुधारें — ऐप यह SMS पैटर्न याद रखेगा',
        'दिशा दुरुस्त करा — ॲप हा SMS पॅटर्न लक्षात ठेवेल',
        'দিক ঠিক করুন — অ্যাপ এই SMS ধরনটি মনে রাখবে',
        'దిశను సరిచేయండి — యాప్ ఈ SMS ఆకృతిని గుర్తుంచుకుంటుంది',
        'திசையை சரிசெய் — இந்த SMS வடிவத்தை ஆப் நினைவில் கொள்ளும்',
      );
  String get selfTransferSuggestionTitle => _t(
        'Looks like a self-transfer',
        'यह अपना ही ट्रांसफर लगता है',
        'हे स्वतःचेच हस्तांतरण दिसते',
        'এটি নিজের অ্যাকাউন্টে স্থানান্তর মনে হচ্ছে',
        'ఇది సొంత బదిలీలా కనిపిస్తోంది',
        'இது சுய பரிமாற்றமாகத் தெரிகிறது',
      );
  String get selfTransferSuggestionBody => _t(
        'An opposite entry of the same amount landed within minutes. Mark both as Self Transfer?',
        'कुछ ही मिनटों में उतनी ही राशि की उलटी प्रविष्टि आई। दोनों को सेल्फ ट्रांसफर चिह्नित करें?',
        'काही मिनिटांत तितक्याच रकमेची उलट नोंद आली. दोन्ही सेल्फ ट्रान्सफर म्हणून चिन्हांकित करायचे?',
        'কয়েক মিনিটের মধ্যে একই অঙ্কের বিপরীত এন্ট্রি এসেছে। দুটিকেই সেলফ ট্রান্সফার চিহ্নিত করবেন?',
        'కొద్ది నిమిషాల్లో అదే మొత్తానికి వ్యతిరేక ఎంట్రీ వచ్చింది. రెండింటినీ సెల్ఫ్ ట్రాన్స్‌ఫర్‌గా గుర్తించాలా?',
        'சில நிமிடங்களில் அதே தொகைக்கு எதிர் பதிவு வந்தது. இரண்டையும் சுய பரிமாற்றமாகக் குறிக்கவா?',
      );
  String get markBoth =>
      _t('Mark both', 'दोनों चिह्नित करें', 'दोन्ही चिन्हांकित करा',
          'দুটিই চিহ্নিত করুন', 'రెండింటినీ గుర్తించు', 'இரண்டையும் குறி');
  String get entryRemoved => _t(
        'Entry removed',
        'प्रविष्टि हटाई गई',
        'नोंद काढली',
        'এন্ট্রি সরানো হয়েছে',
        'ఎంట్రీ తీసివేయబడింది',
        'பதிவு நீக்கப்பட்டது',
      );
  ...
  String get renamePayeeHint => _t('Enter a name you recognise',
      'ऐसा नाम लिखें जो आप पहचानते हों', 'तुम्ही ओळखता असे नाव लिहा', 'আপনি চেনেন এমন একটি নাম লিখুন', 'మీకు గుర్తుండే పేరు రాయండి', 'நீங்கள் அறிந்த பெயரை உள்ளிடவும்');
  String get renamePayeeHelp => _t(
      'Future SMS from this payee will use this name automatically.',
      'इस प्राप्तकर्ता के आगे के SMS अपने आप यही नाम दिखाएँगे।',
      'या प्राप्तकर्त्याचे पुढील SMS आपोआप हेच नाव दाखवतील.',
      'এই প্রাপকের ভবিষ্যতের SMS-এ স্বয়ংক্রিয়ভাবে এই নামটি দেখাবে।',
      'ఈ చెల్లింపుదారు భవిష్యత్ SMSలలో ఈ పేరు ఆటోమేటిక్‌గా కనిపిస్తుంది.',
      'இந்த பணம் பெறுநரின் எதிர்கால SMS-களில் இந்தப் பெயர் தானாகப் பயன்படுத்தப்படும்.');
  String payeeRenamed(int count) => count > 1
      ? _t(
          'Payee renamed — $count transactions updated',
          'प्राप्तकर्ता का नाम बदला गया — $count लेनदेन अपडेट हुए',
          'प्राप्तकर्त्याचे नाव बदलले — $count व्यवहार अपडेट झाले',
          'প্রাপকের নাম বদলানো হয়েছে — $count লেনদেন আপডেট হয়েছে',
          'చెల్లింపుదారు పేరు మార్చబడింది — $count లావాదేవీలు అప్‌డేట్ అయ్యాయి',
          'பணம் பெறுநர் பெயர் மாற்றப்பட்டது — $count பரிவர்த்தனைகள் புதுப்பிக்கப்பட்டன')
      : _t(
          'Payee renamed',
          'प्राप्तकर्ता का नाम बदला गया',
          'प्राप्तकर्त्याचे नाव बदलले',
  ...
  // ── Unnamed-payee tag scope ────────────────────────────────────────────
  // Shown instead of the three options above when the SMS named no
  // counterparty. "Apply to All"/"Apply to Existing" reach other rows by
  // payee name, and the placeholder name is shared by every unrelated
  // nameless alert — so the two are replaced rather than greyed out.
  String get unnamedPayeeTitle => _t(
      'This one has no name',
      'इसका कोई नाम नहीं है',
      'याला नाव नाही',
      'এটির কোনো নাম নেই',
      'దీనికి పేరు లేదు',
      'இதற்குப் பெயர் இல்லை');
  String get unnamedPayeeBody => _t(
        'The alert only carries a reference number, so the app cannot tell '
            'this payment apart from any other unnamed one. Tagging it can '
            'safely reach this transaction only.',
        'अलर्ट में केवल एक संदर्भ संख्या है, इसलिए ऐप इस भुगतान को किसी अन्य बिना नाम वाले भुगतान से अलग नहीं कर सकता। टैग सुरक्षित रूप से केवल इसी लेन-देन तक पहुँच सकता है।',
        'अलर्टमध्ये फक्त संदर्भ क्रमांक आहे, त्यामुळे अ‍ॅप हा व्यवहार इतर नाव नसलेल्या व्यवहारांपासून वेगळा ओळखू शकत नाही. टॅग सुरक्षितपणे फक्त याच व्यवहारापर्यंत पोहोचू शकतो.',
        'সতর্কবার্তায় শুধু একটি রেফারেন্স নম্বর আছে, তাই অ্যাপ এই লেনদেনটিকে অন্য নামহীন লেনদেন থেকে আলাদা করতে পারে না। ট্যাগ নিরাপদে শুধু এই লেনদেনেই পৌঁছাতে পারে।',
        'హెచ్చరికలో రిఫరెన్స్ నంబర్ మాత్రమే ఉంది, కాబట్టి యాప్ ఈ చెల్లింపును పేరు లేని ఇతర చెల్లింపుల నుండి వేరు చేయలేదు. ట్యాగ్ సురక్షితంగా ఈ లావాదేవీకి మాత్రమే చేరగలదు.',
        'எச்சரிக்கையில் ஒரு குறிப்பு எண் மட்டுமே உள்ளது, எனவே பெயரிடப்படாத மற்ற பரிவர்த்தனைகளிலிருந்து இதைப் பயன்பாட்டால் வேறுபடுத்த முடியாது. குறிச்சொல் பாதுகாப்பாக இந்தப் பரிவர்த்தனையை மட்டுமே சென்றடையும்.',
      );
  String get nameThisPayment => _t(
      'Name It & Tag This One',
      'नाम दें और इसे टैग करें',
      'नाव द्या व यालाच टॅग करा',
      'নাম দিন ও এটিতে ট্যাগ করুন',
      'పేరు పెట్టి దీనికి ట్యాగ్ చేయి',
      'பெயரிட்டு இதற்குக் குறியிடு');
  String get nameThisPaymentDesc => _t(
        'Say who this was, then tag this transaction',
        'बताएँ यह किसका था, फिर इस लेन-देन को टैग करें',
        'हा कोणाचा होता ते सांगा, मग या व्यवहाराला टॅग करा',
        'এটি কার ছিল বলুন, তারপর এই লেনদেনে ট্যাগ করুন',
        'ఇది ఎవరిదో చెప్పి, ఈ లావాదేవీకి ట్యాగ్ చేయి',
        'இது யாருடையது எனச் சொல்லி, இந்தப் பரிவர்த்தனைக்குக் குறியிடு',
      );
  ...
  // ── Banks ─────────────────────────────────────────────────────────────────
  // Bank names themselves are proper nouns and stay untranslated ("HDFC Bank"
  // reads as "HDFC Bank" in every language); only the surrounding copy moves.
  String get byBank => _t('By bank', 'बैंक अनुसार', 'बँकनिहाय', 'ব্যাংক অনুযায়ী', 'బ్యాంక్ వారీగా', 'வங்கி வாரியாக');
  String get banksTitle => _t('Banks', 'बैंक', 'बँका', 'ব্যাংক', 'బ్యాంకులు', 'வங்கிகள்');
  String get bankLabel => _t('Bank', 'बैंक', 'बँक', 'ব্যাংক', 'బ్యాంక్', 'வங்கி');
  String get topBankLabel => _t('Most used', 'सर्वाधिक उपयोग', 'सर्वाधिक वापर', 'সর্বাধিক ব্যবহৃত', 'ఎక్కువగా వాడినది', 'அதிகம் பயன்படுத்தியது');
  String get manualEntryBank => _t('Added by you', 'आपके द्वारा जोड़ा गया', 'तुम्ही जोडलेले', 'আপনার যোগ করা', 'మీరు జోడించినవి', 'நீங்கள் சேர்த்தவை');
  String get importedBank => _t('Imported', 'आयातित', 'आयात केलेले', 'আমদানিকৃত', 'దిగుమతి చేసినవి', 'இறக்குமதி செய்தவை');
  // Tagged onto a sender header we couldn't map to a bank, so a raw DLT code
  // never sits in the list pretending to be a bank's name.
  String get unknownBank => _t('Unknown bank', 'अज्ञात बैंक', 'अज्ञात बँक', 'অজানা ব্যাংক', 'తెలియని బ్యాంక్', 'அறியாத வங்கி');
  String spentAcrossBanks(int count) => _t(
      'SPENT FROM $count BANK${count == 1 ? '' : 'S'}',
      '$count बैंकों से खर्च', '$count बँकांमधून खर्च', '$count ব্যাংক থেকে খরচ', '$count బ్యాంకుల నుండి ఖర్చు', '$count வங்கிகளிலிருந்து செலவு');
  String pctOfBankSpend(int pct) =>
      _t('$pct% of bank spend', 'बैंक खर्च का $pct%', 'बँक खर्चाच्या $pct%', 'ব্যাংক খরচের $pct%', 'బ్యాంక్ ఖర్చులో $pct%', 'வங்கிச் செலவில் $pct%');
  String get noBankActivity => _t('No bank activity this month',
      'इस महीने कोई बैंक गतिविधि नहीं', 'या महिन्यात कोणतीही बँक हालचाल नाही', 'এই মাসে কোনো ব্যাংক কার্যকলাপ নেই', 'ఈ నెల బ్యాంక్ కార్యకలాపం లేదు', 'இந்த மாதம் வங்கி நடவடிக்கை இல்லை');
  String get receivedLabel => _t('Received', 'प्राप्त', 'मिळाले', 'প্রাপ্ত', 'అందింది', 'பெறப்பட்டது');
  String movedNotCounted(String amount) => _t(
      '$amount moved, not counted as spending',
      '$amount स्थानांतरित, खर्च में नहीं गिना',
      '$amount हलवले, खर्चात मोजले नाही',
      '$amount স্থানান্তরিত, খরচ হিসেবে গণ্য নয়',
      '$amount బదిలీ, ఖర్చుగా లెక్కించలేదు',
      '$amount இடமாற்றம், செலவாகக் கணக்கிடப்படவில்லை');
  String get banksUsedHint => _t(
      'Only the banks you used this month are listed.',
      'केवल इस महीने उपयोग किए गए बैंक दिखाए गए हैं।',
      'फक्त या महिन्यात वापरलेल्या बँका दाखवल्या आहेत.',
      'শুধু এই মাসে ব্যবহৃত ব্যাংকগুলি দেখানো হয়েছে।',
      'ఈ నెల వాడిన బ్యాంకులు మాత్రమే చూపబడ్డాయి.',
      'இந்த மாதம் பயன்படுத்திய வங்கிகள் மட்டுமே பட்டியலிடப்பட்டுள்ளன.');
  String get exportThisBank => _t('Export', 'निर्यात', 'निर्यात', 'রপ্তানি', 'ఎగుమతి', 'ஏற்றுமதி');
  String get renameBank => _t('Rename this bank', 'इस बैंक का नाम बदलें', 'या बँकेचे नाव बदला', 'এই ব্যাংকের নাম বদলান', 'ఈ బ్యాంక్ పేరు మార్చు', 'இந்த வங்கியை மறுபெயரிடு');
  String renameBankHint(String detected) => _t(
      'Detected as "$detected". A new name changes the label only — these transactions stay linked to the same bank.',
      '"$detected" के रूप में पहचाना गया। नया नाम केवल लेबल बदलता है — ये लेन-देन उसी बैंक से जुड़े रहते हैं।',
      '"$detected" म्हणून ओळखले. नवीन नाव फक्त लेबल बदलते — हे व्यवहार त्याच बँकेशी जोडलेले राहतात.',
      '"$detected" হিসেবে শনাক্ত। নতুন নাম শুধু লেবেল বদলায় — এই লেনদেনগুলি একই ব্যাংকের সঙ্গে যুক্ত থাকে।',
      '"$detected"గా గుర్తించబడింది. కొత్త పేరు లేబుల్‌ను మాత్రమే మారుస్తుంది — ఈ లావాదేవీలు అదే బ్యాంక్‌తో ఉంటాయి.',
      '"$detected" எனக் கண்டறியப்பட்டது. புதிய பெயர் லேபிளை மட்டுமே மாற்றும் — இந்தப் பரிவர்த்தனைகள் அதே வங்கியுடன் இருக்கும்.');
  String get resetToDetectedName => _t('Reset', 'रीसेट', 'रीसेट', 'রিসেট', 'రీసెట్', 'மீட்டமை');
  String bankRenamedTo(String name) =>
      _t('Now showing as $name', 'अब $name के रूप में दिख रहा है', 'आता $name म्हणून दिसत आहे', 'এখন $name হিসেবে দেখাচ্ছে', 'ఇప్పుడు $name గా చూపుతోంది', 'இப்போது $name எனக் காட்டப்படுகிறது');
  String get renameBankTip => _t(
      'Tap the pencil to call a bank whatever you like.',
      'बैंक को अपनी पसंद का नाम देने के लिए पेंसिल दबाएँ।',
      'बँकेला हवे ते नाव देण्यासाठी पेन्सिलवर टॅप करा.',
      'ব্যাংকের পছন্দমতো নাম দিতে পেন্সিলে ট্যাপ করুন।',
      'బ్యాంక్‌కు మీ ఇష్టమైన పేరు పెట్టడానికి పెన్సిల్‌ను నొక్కండి.',
      'வங்கிக்கு விருப்பமான பெயரிட பென்சிலைத் தட்டவும்.');
  ...
  // ── Streak freezes & streak save ────────────────────────────────────────────
  String get streakFreezes => _t('Streak Freezes', 'स्ट्रीक फ़्रीज़', 'स्ट्रीक फ्रीझ', 'স্ট্রিক ফ্রিজ', 'స్ట్రీక్ ఫ్రీజ్‌లు', 'ஸ்ட்ரீக் ஃப்ரீஸ்கள்');
  String get freezeArmedChip => _t('ARMED', 'तैयार', 'सज्ज', 'প্রস্তুত', 'సిద్ధం', 'தயார்');
  String get freezeArmedStatus => _t(
      'Armed — if you miss a day, a freeze bridges it automatically.',
      'तैयार — दिन छूटा तो फ़्रीज़ उसे अपने आप संभाल लेगा।',
      'सज्ज — दिवस चुकला तर फ्रीझ तो आपोआप भरून काढेल.',
      'প্রস্তুত — দিন মিস হলে ফ্রিজ নিজে থেকেই তা পূরণ করবে।',
      'సిద్ధం — ఒక రోజు మిస్ అయితే, ఫ్రీజ్ దాన్ని ఆటోమేటిక్‌గా భర్తీ చేస్తుంది.',
      'தயார் — ஒரு நாள் தவறினால், ஃப்ரீஸ் அதைத் தானாக ஈடுசெய்யும்.');
  String get freezeHowItWorks => _t(
      'A freeze saves your streak when you miss a day — arm one in advance, or spend one per missed day when you come back. Earn one every 5 streak days, plus packs on the road.',
      'दिन छूटने पर फ़्रीज़ आपकी स्ट्रीक बचाता है — पहले से तैयार रखें, या लौटने वाले दिन हर छूटे दिन के लिए एक खर्च करें। हर 5 स्ट्रीक दिनों पर एक मिलता है, साथ ही रोड पर पैक भी।',
      'दिवस चुकल्यावर फ्रीझ तुमची स्ट्रीक वाचवतो — आधीच सज्ज ठेवा, किंवा परत आल्याच्या दिवशी प्रत्येक चुकलेल्या दिवसासाठी एक वापरा. दर 5 स्ट्रीक दिवसांनी एक मिळतो, शिवाय रोडवर पॅकही.',
      'দিন মিস হলে ফ্রিজ আপনার স্ট্রিক বাঁচায় — আগে থেকে প্রস্তুত রাখুন, বা ফিরে আসার দিনে প্রতিটি মিস হওয়া দিনের জন্য একটি খরচ করুন। প্রতি 5 স্ট্রিক দিনে একটি পাবেন, সাথে রোডে প্যাকও।',
      'ఒక రోజు మిస్ అయినప్పుడు ఫ్రీజ్ మీ స్ట్రీక్‌ను కాపాడుతుంది — ముందుగా సిద్ధం చేసుకోండి, లేదా తిరిగి వచ్చిన రోజే మిస్ అయిన ప్రతి రోజుకు ఒకటి ఖర్చు చేయండి. ప్రతి 5 స్ట్రీక్ రోజులకు ఒకటి, రోడ్‌పై ప్యాక్‌లు కూడా.',
      'ஒரு நாள் தவறும்போது ஃப்ரீஸ் உங்கள் ஸ்ட்ரீக்கைக் காப்பாற்றும் — முன்கூட்டியே தயார்படுத்துங்கள், அல்லது திரும்பி வரும் நாளில் தவறிய ஒவ்வொரு நாளுக்கும் ஒன்று செலவழியுங்கள். ஒவ்வொரு 5 ஸ்ட்ரீக் நாட்களுக்கும் ஒன்று, ரோடில் பேக்குகளும் கிடைக்கும்.');
  String get armFreezeCta => _t('Arm a freeze', 'फ़्रीज़ तैयार करें', 'फ्रीझ सज्ज करा', 'ফ্রিজ প্রস্তুত করুন', 'ఫ్రీజ్ సిద్ధం చేయండి', 'ஃப்ரீஸைத் தயார்படுத்து');
  String get freezeArmedToast => _t(
      'Streak freeze armed — your streak survives one missed day.',
      'स्ट्रीक फ़्रीज़ तैयार — एक छूटा दिन आपकी स्ट्रीक नहीं तोड़ेगा।',
      'स्ट्रीक फ्रीझ सज्ज — एक चुकलेला दिवस तुमची स्ट्रीक मोडणार नाही.',
      'স্ট্রিক ফ্রিজ প্রস্তুত — একটি মিস হওয়া দিন আপনার স্ট্রিক ভাঙবে না।',
      'స్ట్రీక్ ఫ్రీజ్ సిద్ధం — ఒక మిస్ అయిన రోజు మీ స్ట్రీక్‌ను విరవదు.',
      'ஸ்ட்ரீக் ஃப்ரீஸ் தயார் — ஒரு தவறிய நாள் உங்கள் ஸ்ட்ரீக்கை முறிக்காது.');
  String get streakSaveLabel => _t('STREAK SAVE', 'स्ट्रीक सेव', 'स्ट्रीक सेव्ह', 'স্ট্রিক সেভ', 'స్ట్రీక్ సేవ్', 'ஸ்ட்ரீக் சேவ்');
  String streakSaveTitle(int prev) => _t(
      'Save your $prev-day streak?',
      'अपनी $prev-दिन की स्ट्रीक बचाएँ?',
      'तुमची $prev-दिवसांची स्ट्रीक वाचवायची?',
      'আপনার $prev-দিনের স্ট্রিক বাঁচাবেন?',
      'మీ $prev-రోజుల స్ట్రీక్‌ను కాపాడతారా?',
      'உங்கள் $prev-நாள் ஸ்ட்ரீக்கைக் காப்பாற்றவா?');
  /// The save sheet's body. [missed] days were skipped and cost one freeze
  /// each; [restored] is where the streak lands if they are all bridged.
  String streakSaveBody(int restored, int missed) => missed == 1
      ? _t(
          'You missed a day and your flame went cold. Spend one Streak Freeze to carry on at $restored days — this offer melts away tomorrow.',
          'एक दिन छूटा और आपकी लौ ठंडी पड़ गई। एक स्ट्रीक फ़्रीज़ खर्च करें और $restored दिनों से आगे बढ़ें — यह मौका कल पिघल जाएगा।',
          'एक दिवस चुकला आणि तुमची ज्योत थंड झाली. एक स्ट्रीक फ्रीझ वापरा आणि $restored दिवसांपासून पुढे चला — ही संधी उद्या वितळून जाईल.',
          'একটি দিন মিস হয়েছে আর আপনার শিখা ঠান্ডা হয়ে গেছে। একটি স্ট্রিক ফ্রিজ খরচ করে $restored দিন থেকে এগিয়ে যান — এই সুযোগ আগামীকাল গলে যাবে।',
          'ఒక రోజు మిస్ అయింది, మీ జ్వాల చల్లబడింది. ఒక స్ట్రీక్ ఫ్రీజ్ ఖర్చు చేసి $restored రోజుల నుండి కొనసాగండి — ఈ అవకాశం రేపు కరిగిపోతుంది.',
          'ஒரு நாள் தவறியது, உங்கள் சுடர் குளிர்ந்தது. ஒரு ஸ்ட்ரீக் ஃப்ரீஸைச் செலவழித்து $restored நாட்களில் தொடருங்கள் — இந்த வாய்ப்பு நாளை உருகிவிடும்.')
      : _t(
          'You missed $missed days and your flame went cold. Spend $missed Streak Freezes to carry on at $restored days — this offer melts away tomorrow.',
          '$missed दिन छूट गए और आपकी लौ ठंडी पड़ गई। $missed स्ट्रीक फ़्रीज़ खर्च करें और $restored दिनों से आगे बढ़ें — यह मौका कल पिघल जाएगा।',
          '$missed दिवस चुकले आणि तुमची ज्योत थंड झाली. $missed स्ट्रीक फ्रीझ वापरा आणि $restored दिवसांपासून पुढे चला — ही संधी उद्या वितळून जाईल.',
          '$missed দিন মিস হয়েছে আর আপনার শিখা ঠান্ডা হয়ে গেছে। $missed স্ট্রিক ফ্রিজ খরচ করে $restored দিন থেকে এগিয়ে যান — এই সুযোগ আগামীকাল গলে যাবে।',
          '$missed రోజులు మిస్ అయ్యాయి, మీ జ్వాల చల్లబడింది. $missed స్ట్రీక్ ఫ్రీజ్‌లు ఖర్చు చేసి $restored రోజుల నుండి కొనసాగండి — ఈ అవకాశం రేపు కరిగిపోతుంది.',
          '$missed நாட்கள் தவறின, உங்கள் சுடர் குளிர்ந்தது. $missed ஸ்ட்ரீக் ஃப்ரீஸ்களைச் செலவழித்து $restored நாட்களில் தொடருங்கள் — இந்த வாய்ப்பு நாளை உருகிவிடும்.');
  String freezesLeftLabel(int n) => _t(
      '$n ${n == 1 ? 'freeze' : 'freezes'} in your stash',
      'आपके पास $n फ़्रीज़',
      'तुमच्याकडे $n फ्रीझ',
      'আপনার কাছে $n ফ্রিজ',
      'మీ వద్ద $n ఫ్రీజ్‌లు',
      'உங்களிடம் $n ஃப்ரீஸ்கள்');
  /// The save sheet's confirm button: [n] freezes are about to be spent.
  String useFreezeCta(int n) => n == 1
      ? _t('Use a Streak Freeze', 'स्ट्रीक फ़्रीज़ इस्तेमाल करें', 'स्ट्रीक फ्रीझ वापरा', 'স্ট্রিক ফ্রিজ ব্যবহার করুন', 'స్ట్రీక్ ఫ్రీజ్ వాడండి', 'ஸ்ட்ரீக் ஃப்ரீஸைப் பயன்படுத்து')
      : _t('Use $n Streak Freezes', '$n स्ट्रीक फ़्रीज़ इस्तेमाल करें', '$n स्ट्रीक फ्रीझ वापरा', '$n স্ট্রিক ফ্রিজ ব্যবহার করুন', '$n స్ట్రీక్ ఫ్రీజ్‌లు వాడండి', '$n ஸ்ட்ரீக் ஃப்ரீஸ்களைப் பயன்படுத்து');
  String get startFreshCta => _t('Start fresh from Day 1', 'दिन 1 से नई शुरुआत', 'दिवस 1 पासून नवी सुरुवात', 'দিন 1 থেকে নতুন শুরু', 'రోజు 1 నుండి కొత్తగా ప్రారంభించండి', 'நாள் 1-இல் புதிதாகத் தொடங்கு');
  String streakRestoredToast(int n) => _t(
      'Streak restored — $n days and burning!',
      'स्ट्रीक बहाल — $n दिन और जलती हुई!',
      'स्ट्रीक पुन्हा सुरू — $n दिवस आणि धगधगती!',
      'স্ট্রিক ফিরে এসেছে — $n দিন আর জ্বলছে!',
      'స్ట్రీక్ పునరుద్ధరించబడింది — $n రోజులు, మండుతూనే ఉంది!',
      'ஸ்ட்ரீக் மீட்கப்பட்டது — $n நாட்கள், எரிந்து கொண்டே!');
  String restoreStreakTitle(int prev) => _t(
      'Restore your $prev-day streak',
      'अपनी $prev-दिन की स्ट्रीक बहाल करें',
      'तुमची $prev-दिवसांची स्ट्रीक पुन्हा मिळवा',
      'আপনার $prev-দিনের স্ট্রিক ফিরিয়ে আনুন',
      'మీ $prev-రోజుల స్ట్రీక్‌ను తిరిగి పొందండి',
      'உங்கள் $prev-நாள் ஸ்ட்ரீக்கை மீட்டெடுங்கள்');
  String streakSaveBannerBody(int missed) => missed == 1
      ? _t(
          'You missed a day — spend a freeze to pick your streak right back up. Today only.',
          'एक दिन छूट गया — एक फ़्रीज़ खर्च कर स्ट्रीक वहीं से जारी रखें। सिर्फ़ आज।',
          'एक दिवस चुकला — एक फ्रीझ वापरून स्ट्रीक तिथूनच पुढे न्या. फक्त आज.',
          'একটি দিন মিস হয়েছে — একটি ফ্রিজ খরচ করে স্ট্রিক সেখান থেকেই চালিয়ে যান। শুধু আজ।',
          'ఒక రోజు మిస్ అయింది — ఒక ఫ్రీజ్ ఖర్చు చేసి మీ స్ట్రీక్‌ను అక్కడి నుండే కొనసాగించండి. ఈ రోజు మాత్రమే.',
          'ஒரு நாள் தவறியது — ஒரு ஃப்ரீஸைச் செலவழித்து ஸ்ட்ரீக்கை அங்கிருந்தே தொடருங்கள். இன்று மட்டும்.')
      : _t(
          'You missed $missed days — spend $missed freezes to pick your streak right back up. Today only.',
          '$missed दिन छूट गए — $missed फ़्रीज़ खर्च कर स्ट्रीक वहीं से जारी रखें। सिर्फ़ आज।',
          '$missed दिवस चुकले — $missed फ्रीझ वापरून स्ट्रीक तिथूनच पुढे न्या. फक्त आज.',
          '$missed দিন মিস হয়েছে — $missed ফ্রিজ খরচ করে স্ট্রিক সেখান থেকেই চালিয়ে যান। শুধু আজ।',
          '$missed రోజులు మిస్ అయ్యాయి — $missed ఫ్రీజ్‌లు ఖర్చు చేసి మీ స్ట్రీక్‌ను అక్కడి నుండే కొనసాగించండి. ఈ రోజు మాత్రమే.',
          '$missed நாட்கள் தவறின — $missed ஃப்ரீஸ்களைச் செலவழித்து ஸ்ட்ரீக்கை அங்கிருந்தே தொடருங்கள். இன்று மட்டும்.');
  String get restoreCta => _t('Restore', 'बहाल करें', 'पुन्हा मिळवा', 'ফিরিয়ে আনুন', 'తిరిగి పొందండి', 'மீட்டெடு');
  String get freezePackAdded => _t(
      'Added to your freeze stash',
      'आपके फ़्रीज़ भंडार में जुड़ गया',
      'तुमच्या फ्रीझ साठ्यात जमा झाले',
      'আপনার ফ্রিজ ভাণ্ডারে যোগ হয়েছে',
      'మీ ఫ్రీజ్ నిల్వకు జోడించబడింది',
      'உங்கள் ஃப்ரீஸ் இருப்பில் சேர்க்கப்பட்டது');
  ...
  String get themePreviewAction =>
      _t('Preview', 'झलक देखें', 'झलक पहा', 'প্রিভিউ', 'ప్రివ్యూ', 'முன்னோட்டம்');
  ...
  String get onboardWelcomeTitle => _t('Welcome to\nBudgetify',
      'Budgetify में\nआपका स्वागत है', 'Budgetify मध्ये\nआपले स्वागत आहे', 'Budgetify-এ\nস্বাগতম', 'స్వాగతం\nBudgetify', 'வரவேற்பு\nBudgetify');
  ...
  // Feature highlights on the modernised welcome page.
  String get onboardFeatSmsTitle => _t('Automatic SMS tracking', 'स्वचालित SMS ट्रैकिंग',
      'स्वयंचलित SMS ट्रॅकिंग', 'স্বয়ংক্রিয় SMS ট্র্যাকিং', 'ఆటోమేటిక్ SMS ట్రాకింగ్', 'தானியங்கி SMS கண்காணிப்பு');
  String get onboardFeatSmsDesc => _t('Every bank debit and credit, sorted for you',
      'हर बैंक डेबिट और क्रेडिट, आपके लिए क्रमबद्ध',
      'प्रत्येक बँक डेबिट व क्रेडिट, तुमच्यासाठी क्रमवारीत',
      'প্রতিটি ব্যাংক ডেবিট ও ক্রেডিট, আপনার জন্য সাজানো',
      'ప్రతి బ్యాంక్ డెబిట్, క్రెడిట్ మీ కోసం క్రమబద్ధం',
      'ஒவ்வொரு வங்கி டெபிட், கிரெடிட், உங்களுக்காக வரிசைப்படுத்தப்படும்');
  String get onboardFeatInsightsTitle => _t('Budgets & insights', 'बजट और अंतर्दृष्टि',
      'बजेट व अंतर्दृष्टी', 'বাজেট ও অন্তর্দৃষ্টি', 'బడ్జెట్‌లు & అంతర్దృష్టులు', 'பட்ஜெட் & நுண்ணறிவு');
  String get onboardFeatInsightsDesc => _t('Net worth, trends, streaks and rewards',
      'नेट वर्थ, रुझान, स्ट्रीक और रिवॉर्ड',
      'नेट वर्थ, कल, स्ट्रीक व बक्षिसे',
      'নেট ওয়ার্থ, ট্রেন্ড, স্ট্রিক ও পুরস্কার',
      'నెట్‌వర్త్, ట్రెండ్‌లు, స్ట్రీక్‌లు, రివార్డ్‌లు',
      'நிகர மதிப்பு, போக்குகள், தொடர்ச்சி & வெகுமதிகள்');
  String get onboardFeatPrivacyTitle => _t('Private by design', 'डिज़ाइन से निजी',
      'डिझाइननेच खाजगी', 'ডিজাইনেই ব্যক্তিগত', 'డిజైన్‌లోనే ప్రైవేట్', 'வடிவமைப்பால் தனிப்பட்டது');
  String get onboardFeatPrivacyDesc => _t('Nothing leaves your phone — ever',
      'कुछ भी आपके फ़ोन से बाहर नहीं जाता — कभी नहीं',
      'काहीही तुमच्या फोनबाहेर जात नाही — कधीही',
      'কিছুই আপনার ফোন থেকে বের হয় না — কখনও নয়',
      'ఏదీ మీ ఫోన్ నుండి బయటకు వెళ్లదు — ఎప్పటికీ',
      'எதுவும் உங்கள் மொபைலை விட்டு வெளியேறாது — எப்போதும்');
  ...
  // ── Clearing tags ─────────────────────────────────────────────────────────
  String get clearTag => _t('Clear', 'हटाएँ', 'काढा', 'সরান', 'తీసివేయి', 'அகற்று');
  String get clearTagAction =>
      _t('Clear tag', 'टैग हटाएँ', 'टॅग काढा', 'ট্যাগ সরান', 'ట్యాగ్ తీసివేయి', 'குறிச்சொல்லை அகற்று');
  String get tagActionsTooltip =>
      _t('Tag actions', 'टैग क्रियाएँ', 'टॅग क्रिया', 'ট্যাগ ক্রিয়া', 'ట్యాగ్ చర్యలు', 'குறிச்சொல் செயல்கள்');
  String get tagRestored => _t('Tag restored', 'टैग वापस लाया गया', 'टॅग परत आणला',
      'ট্যাগ ফিরিয়ে আনা হয়েছে', 'ట్యాగ్ పునరుద్ధరించబడింది', 'குறிச்சொல் மீட்டமைக்கப்பட்டது');
  String clearTagTitle(String tag) => _t('Clear "$tag"?', '"$tag" हटाएँ?',
      '"$tag" काढायचा?', '"$tag" সরাবেন?', '"$tag" తీసివేయాలా?', '"$tag" ஐ அகற்றவா?');
  String clearTagSubtitle(String payee) => _t(
        'Choose how far this should reach — the same three distances tagging '
            'offers, in reverse.',
        'चुनें कि यह कहाँ तक लागू हो — टैग करते समय दिए गए वही तीन विकल्प, उलटे क्रम में।',
        'हे किती दूर पोहोचावे ते निवडा — टॅग करताना दिलेले तेच तीन पर्याय, उलट.',
        'এটি কতদূর পৌঁছাবে বেছে নিন — ট্যাগ করার সময়ের সেই তিনটি বিকল্পই, বিপরীতে।',
        'ఇది ఎంత దూరం వర్తించాలో ఎంచుకోండి — ట్యాగ్ చేసేటప్పుడు ఇచ్చిన అదే మూడు ఎంపికలు, వ్యతిరేకంగా.',
        'இது எவ்வளவு தூரம் செல்ல வேண்டும் என்பதைத் தேர்வுசெய்க — குறிச்சொல் இடும்போது வழங்கிய அதே மூன்று விருப்பங்கள், தலைகீழாக.',
      );
  String get clearOnlyThis => _t('Only this one', 'केवल यही', 'फक्त हाच',
      'শুধু এটি', 'ఇది మాత్రమే', 'இது மட்டும்');
  String get clearOnlyThisDesc => _t(
        'Remove the tag from this transaction alone.',
        'केवल इसी लेन-देन से टैग हटाएँ।',
        'फक्त याच व्यवहारातून टॅग काढा.',
        'শুধু এই লেনদেন থেকে ট্যাগ সরান।',
        'ఈ లావాదేవీ నుండి మాత్రమే ట్యాగ్ తీసివేయండి.',
        'இந்தப் பரிவர்த்தனையிலிருந்து மட்டும் குறிச்சொல்லை அகற்று.',
      );
  String get clearAllFromPayee => _t('All from this payee', 'इस प्राप्तकर्ता के सभी',
      'या प्राप्तकर्त्याचे सर्व', 'এই প্রাপকের সব', 'ఈ చెల్లింపుదారు నుండి అన్నీ', 'இந்தப் பெறுநரின் அனைத்தும்');
  String clearAllFromPayeeDesc(int count, String payee) => _t(
        'Remove it from all $count transactions from $payee.',
        '$payee के सभी $count लेन-देन से हटाएँ।',
        '$payee च्या सर्व $count व्यवहारांमधून काढा.',
        '$payee-এর সব $count টি লেনদেন থেকে সরান।',
        '$payee నుండి అన్ని $count లావాదేవీల నుండి తీసివేయండి.',
        '$payee-இன் அனைத்து $count பரிவர்த்தனைகளிலிருந்தும் அகற்று.',
      );
  String get clearAllAndStopRule => _t(
      'All, and stop auto-tagging',
      'सभी, और स्वतः-टैग बंद करें',
      'सर्व, आणि स्वयं-टॅग थांबवा',
      'সব, এবং স্বয়ংক্রিয় ট্যাগিং বন্ধ করুন',
      'అన్నీ, మరియు ఆటో-ట్యాగింగ్ ఆపండి',
      'அனைத்தும், தானியங்கு குறிச்சொல்லை நிறுத்து');
  String clearAllAndStopRuleDesc(int count, String payee) => _t(
        'Clear all $count and delete the rule that keeps tagging $payee — the '
            'undo of "Apply to All".',
        'सभी $count हटाएँ और वह नियम मिटाएँ जो $payee को टैग करता रहता है — '
            '"सभी पर लागू करें" का उलटा।',
        'सर्व $count काढा आणि $payee ला टॅग करत राहणारा नियम हटवा — '
            '"सर्वांना लागू करा" चे उलट.',
        'সব $count সরান এবং $payee-কে ট্যাগ করতে থাকা নিয়মটি মুছুন — '
            '"সবগুলোতে প্রয়োগ"-এর বিপরীত।',
        'అన్ని $count తీసివేసి, $payee ను ట్యాగ్ చేస్తూనే ఉండే నియమాన్ని తొలగించండి — "అన్నింటికీ వర్తింపజేయి" యొక్క రద్దు.',
        'அனைத்து $count ஐயும் அகற்றி, $payee ஐ குறிச்சொல் இட்டுக்கொண்டே இருக்கும் விதியை நீக்கு — "அனைத்திற்கும் பயன்படுத்து" வின் மறுசெயல்.',
      );
  String get clearTagUndoHint => _t(
        'You can undo this straight after.',
        'आप इसे तुरंत बाद पूर्ववत कर सकते हैं।',
        'तुम्ही हे लगेच पूर्ववत करू शकता.',
        'আপনি এটি সঙ্গে সঙ্গে পূর্বাবস্থায় ফেরাতে পারেন।',
        'మీరు దీన్ని వెంటనే రద్దు చేయవచ్చు.',
        'இதை உடனடியாக மீட்டமைக்கலாம்.',
      );
  String clearedFromCount(int count, String payee) => _t(
        'Tag cleared from $count transactions from $payee',
        '$payee के $count लेन-देन से टैग हटाया गया',
        '$payee च्या $count व्यवहारांमधून टॅग काढला',
        '$payee-এর $count টি লেনদেন থেকে ট্যাগ সরানো হয়েছে',
        '$payee నుండి $count లావాదేవీల నుండి ట్యాగ్ తీసివేయబడింది',
        '$payee-இன் $count பரிவர்த்தனைகளிலிருந்து குறிச்சொல் அகற்றப்பட்டது',
      );
  String clearedAndStoppedRule(int count, String payee) => _t(
        'Cleared $count and stopped auto-tagging $payee',
        '$count हटाए और $payee का स्वतः-टैग बंद किया',
        '$count काढले आणि $payee चा स्वयं-टॅग थांबवला',
        '$count সরানো হয়েছে এবং $payee-এর স্বয়ংক্রিয় ট্যাগিং বন্ধ',
        '$count తీసివేయబడ్డాయి, $payee ఆటో-ట్యాగింగ్ ఆగింది',
        '$count அகற்றப்பட்டன, $payee தானியங்கு குறிச்சொல் நிறுத்தப்பட்டது',
      );
  String clearFromTransactions(int count) => _t(
        count == 0 ? 'Nothing to clear' : 'Clear from $count transactions',
        count == 0 ? 'हटाने को कुछ नहीं' : '$count लेन-देन से हटाएँ',
        count == 0 ? 'काढण्यासारखे काही नाही' : '$count व्यवहारांमधून काढा',
        count == 0 ? 'সরানোর কিছু নেই' : '$count টি লেনদেন থেকে সরান',
        count == 0 ? 'తీసివేయడానికి ఏమీ లేదు' : '$count లావాదేవీల నుండి తీసివేయి',
        count == 0 ? 'அகற்ற எதுவும் இல்லை' : '$count பரிவர்த்தனைகளிலிருந்து அகற்று',
      );
  String clearTagFromAllTitle(String tag) => _t(
        'Clear "$tag" everywhere?',
        'हर जगह से "$tag" हटाएँ?',
        'सर्वत्र "$tag" काढायचा?',
        'সর্বত্র "$tag" সরাবেন?',
        'ప్రతిచోటా "$tag" తీసివేయాలా?',
        'எல்லா இடத்திலிருந்தும் "$tag" ஐ அகற்றவா?',
      );
  String clearTagFromAllDesc(int count, int rules, String tag) {
    final ruleNote = rules == 0
        ? ''
        : _t(
            ' $rules auto-tag rule${rules == 1 ? '' : 's'} for "$tag" '
                '${rules == 1 ? 'is' : 'are'} removed too, so it does not come '
                'back.',
            ' "$tag" के $rules स्वतः-टैग नियम भी हटेंगे, ताकि यह वापस न आए।',
            ' "$tag" चे $rules स्वयं-टॅग नियमही हटतील, म्हणजे तो परत येणार नाही.',
            ' "$tag"-এর $rules টি স্বয়ংক্রিয় ট্যাগ নিয়মও সরানো হবে, যাতে এটি ফিরে না আসে।',
            ' "$tag" కోసం $rules ఆటో-ట్యాగ్ నియమాలు కూడా తీసివేయబడతాయి, తద్వారా అది తిరిగి రాదు.',
            ' "$tag" க்கான $rules தானியங்கு விதிகளும் அகற்றப்படும், அது திரும்ப வராது.',
          );
    final head = _t(
      '$count transaction${count == 1 ? '' : 's'} will become unclassified. '
          'The tag itself is kept.',
      '$count लेन-देन अवर्गीकृत हो जाएँगे। टैग स्वयं बना रहेगा।',
      '$count व्यवहार अवर्गीकृत होतील. टॅग स्वतः राहील.',
      '$count টি লেনদেন অশ্রেণীবদ্ধ হয়ে যাবে। ট্যাগটি থেকে যাবে।',
      '$count లావాదేవీలు వర్గీకరించనివిగా మారతాయి. ట్యాగ్ అలాగే ఉంటుంది.',
      '$count பரிவர்த்தனைகள் வகைப்படுத்தப்படாதவையாக மாறும். குறிச்சொல் அப்படியே இருக்கும்.',
    );
    return '$head$ruleNote';
  }
  String clearedTagFromAll(int count, String tag) => _t(
        'Cleared "$tag" from $count transaction${count == 1 ? '' : 's'}',
        '$count लेन-देन से "$tag" हटाया',
        '$count व्यवहारांमधून "$tag" काढला',
        '$count টি লেনদেন থেকে "$tag" সরানো হয়েছে',
        '$count లావాదేవీల నుండి "$tag" తీసివేయబడింది',
        '$count பரிவர்த்தனைகளிலிருந்து "$tag" அகற்றப்பட்டது',
      );

  // ── Auto-tag rules ────────────────────────────────────────────────────────
  String get autoTagRules => _t('Auto-tag rules', 'स्वतः-टैग नियम', 'स्वयं-टॅग नियम',
      'স্বয়ংক্রিয় ট্যাগ নিয়ম', 'ఆటో-ట్యాగ్ నియమాలు', 'தானியங்கு குறிச்சொல் விதிகள்');
  String get autoTagRulesDesc => _t(
      'See and undo what "Apply to All" set up',
      '"सभी पर लागू करें" से बने नियम देखें और हटाएँ',
      '"सर्वांना लागू करा" ने बनवलेले नियम पाहा व काढा',
      '"সবগুলোতে প্রয়োগ" যা তৈরি করেছে তা দেখুন ও সরান',
      '"అన్నింటికీ వర్తింపజేయి" సెటప్ చేసినవి చూసి రద్దు చేయండి',
      '"அனைத்திற்கும் பயன்படுத்து" அமைத்ததைப் பார்த்து நீக்கு');
  String get autoTagRulesIntro => _t(
        'Choosing "Apply to All" writes a rule that keeps tagging new '
            'transactions from a payee. Pause one, or delete it and take back '
            'what it tagged.',
        '"सभी पर लागू करें" चुनने पर एक नियम बनता है जो उस प्राप्तकर्ता के नए '
            'लेन-देन को टैग करता रहता है। इसे रोकें, या हटाकर किया गया टैग वापस लें।',
        '"सर्वांना लागू करा" निवडल्यास एक नियम तयार होतो जो त्या प्राप्तकर्त्याचे '
            'नवे व्यवहार टॅग करत राहतो. तो थांबवा, किंवा हटवून केलेले टॅग परत घ्या.',
        '"সবগুলোতে প্রয়োগ" বেছে নিলে একটি নিয়ম তৈরি হয় যা ওই প্রাপকের নতুন '
            'লেনদেন ট্যাগ করতে থাকে। থামান, বা মুছে যা ট্যাগ হয়েছে তা ফিরিয়ে নিন।',
        '"అన్నింటికీ వర్తింపజేయి" ఎంచుకుంటే ఒక నియమం తయారవుతుంది, అది ఆ చెల్లింపుదారు కొత్త లావాదేవీలను ట్యాగ్ చేస్తూనే ఉంటుంది. దాన్ని ఆపండి, లేదా తొలగించి ట్యాగ్ చేసినవి వెనక్కి తీసుకోండి.',
        '"அனைத்திற்கும் பயன்படுத்து" தேர்வு ஒரு விதியை உருவாக்கும், அது அந்தப் பெறுநரின் புதிய பரிவர்த்தனைகளைத் தொடர்ந்து குறிச்சொல் இடும். நிறுத்துங்கள், அல்லது நீக்கி இட்டதைத் திரும்பப் பெறுங்கள்.',
      );
  String get noAutoTagRules => _t('No auto-tag rules yet', 'अभी कोई स्वतः-टैग नियम नहीं',
      'अद्याप स्वयं-टॅग नियम नाहीत', 'এখনও কোনো স্বয়ংক্রিয় ট্যাগ নিয়ম নেই',
      'ఇంకా ఆటో-ట్యాగ్ నియమాలు లేవు', 'இதுவரை தானியங்கு விதிகள் இல்லை');
  String get noAutoTagRulesDesc => _t(
        'Tag a transaction and choose "Apply to All" to create one.',
        'किसी लेन-देन को टैग करके "सभी पर लागू करें" चुनें।',
        'एखादा व्यवहार टॅग करून "सर्वांना लागू करा" निवडा.',
        'একটি লেনদেন ট্যাগ করে "সবগুলোতে প্রয়োগ" বেছে নিন।',
        'ఒక లావాదేవీని ట్యాగ్ చేసి "అన్నింటికీ వర్తింపజేయి" ఎంచుకోండి.',
        'ஒரு பரிவர்த்தனையைக் குறிச்சொல் இட்டு "அனைத்திற்கும் பயன்படுத்து" தேர்வுசெய்க.',
      );
  String ruleMeta(String tag, bool isDebit, int count, bool paused) {
    final dir = isDebit
        ? _t('Spends', 'खर्च', 'खर्च', 'খরচ', 'ఖర్చులు', 'செலவுகள்')
        : _t('Credits', 'जमा', 'जमा', 'জমা', 'జమలు', 'வரவுகள்');
    final usage = _t('$count tagged', '$count पर टैग', '$count टॅग केलेले',
        '$count টি ট্যাগ করা', '$count ట్యాగ్ చేయబడ్డాయి', '$count குறிச்சொல் இடப்பட்டன');
    final state = paused
        ? _t('Paused', 'रुका हुआ', 'थांबवलेले', 'বিরাম', 'ఆగింది', 'இடைநிறுத்தம்')
        : null;
    return [dir, '→ $tag', usage, if (state != null) state].join(' · ');
  }
  String deleteRuleTitle(String payee) => _t(
        'Stop auto-tagging $payee?',
        '$payee का स्वतः-टैग बंद करें?',
        '$payee चा स्वयं-टॅग थांबवायचा?',
        '$payee-এর স্বয়ংক্রিয় ট্যাগিং বন্ধ করবেন?',
        '$payee ఆటో-ట్యాగింగ్ ఆపాలా?',
        '$payee தானியங்கு குறிச்சொல்லை நிறுத்தவா?',
      );
  String deleteRuleSubtitle(String payee, String tag) => _t(
        'New transactions from $payee are being tagged "$tag" automatically.',
        '$payee के नए लेन-देन स्वतः "$tag" टैग हो रहे हैं।',
        '$payee चे नवे व्यवहार आपोआप "$tag" टॅग होत आहेत.',
        '$payee-এর নতুন লেনদেন স্বয়ংক্রিয়ভাবে "$tag" ট্যাগ হচ্ছে।',
        '$payee కొత్త లావాదేవీలు స్వయంచాలకంగా "$tag" ట్యాగ్ అవుతున్నాయి.',
        '$payee-இன் புதிய பரிவர்த்தனைகள் தானாக "$tag" குறிச்சொல் பெறுகின்றன.',
      );
  String get deleteRuleKeepTags => _t('Stop from now on', 'अब से बंद करें',
      'आतापासून थांबवा', 'এখন থেকে বন্ধ', 'ఇప్పటి నుండి ఆపండి', 'இனி நிறுத்து');
  String get deleteRuleKeepTagsDesc => _t(
        'Delete the rule. Transactions already tagged keep their tag.',
        'नियम मिटाएँ। पहले से टैग किए लेन-देन का टैग बना रहेगा।',
        'नियम हटवा. आधीच टॅग केलेले व्यवहार तसेच राहतील.',
        'নিয়মটি মুছুন। আগে ট্যাগ হওয়া লেনদেন ট্যাগ রেখে দেবে।',
        'నియమాన్ని తొలగించండి. ఇప్పటికే ట్యాగ్ చేసిన లావాదేవీలు అలాగే ఉంటాయి.',
        'விதியை நீக்கு. ஏற்கனவே குறிச்சொல் இட்டவை அப்படியே இருக்கும்.',
      );
  String get deleteRuleAndClear => _t('Stop and clear tags', 'बंद करें और टैग हटाएँ',
      'थांबवा आणि टॅग काढा', 'বন্ধ করে ট্যাগ সরান', 'ఆపి ట్యాగ్‌లు తీసివేయి', 'நிறுத்தி குறிச்சொற்களை அகற்று');
  String deleteRuleAndClearDesc(int count, String tag) => _t(
        'Delete the rule and remove "$tag" from the $count transactions it '
            'tagged.',
        'नियम मिटाएँ और उसके द्वारा टैग किए $count लेन-देन से "$tag" हटाएँ।',
        'नियम हटवा आणि त्याने टॅग केलेल्या $count व्यवहारांमधून "$tag" काढा.',
        'নিয়মটি মুছুন এবং এটি ট্যাগ করা $count টি লেনদেন থেকে "$tag" সরান।',
        'నియమాన్ని తొలగించి, అది ట్యాగ్ చేసిన $count లావాదేవీల నుండి "$tag" తీసివేయండి.',
        'விதியை நீக்கி, அது குறிச்சொல் இட்ட $count பரிவர்த்தனைகளிலிருந்து "$tag" ஐ அகற்று.',
      );
  String get pauseRuleTooltip => _t('Pause rule', 'नियम रोकें', 'नियम थांबवा',
      'নিয়ম বিরাম', 'నియమాన్ని ఆపు', 'விதியை இடைநிறுத்து');
  String get resumeRuleTooltip => _t('Resume rule', 'नियम फिर चालू करें',
      'नियम पुन्हा सुरू करा', 'নিয়ম চালু করুন', 'నియమాన్ని కొనసాగించు', 'விதியை மீண்டும் தொடங்கு');
  String get deleteRuleTooltip => _t('Delete rule', 'नियम मिटाएँ', 'नियम हटवा',
      'নিয়ম মুছুন', 'నియమాన్ని తొలగించు', 'விதியை நீக்கு');
  String rulePaused(String payee) => _t('Paused the rule for $payee',
      '$payee का नियम रोका', '$payee चा नियम थांबवला', '$payee-এর নিয়ম বিরাম',
      '$payee నియమం ఆగింది', '$payee விதி இடைநிறுத்தப்பட்டது');
  String ruleResumed(String payee) => _t('Resumed the rule for $payee',
      '$payee का नियम फिर चालू', '$payee चा नियम पुन्हा सुरू', '$payee-এর নিয়ম চালু',
      '$payee నియమం కొనసాగుతోంది', '$payee விதி மீண்டும் இயங்குகிறது');
  String ruleDeleted(String payee) => _t('Stopped auto-tagging $payee',
      '$payee का स्वतः-टैग बंद', '$payee चा स्वयं-टॅग बंद', '$payee-এর স্বয়ংক্রিয় ট্যাগিং বন্ধ',
      '$payee ఆటో-ట్యాగింగ్ ఆగింది', '$payee தானியங்கு குறிச்சொல் நிறுத்தப்பட்டது');
  String ruleDeletedAndCleared(int count, String payee) => _t(
        'Stopped $payee and cleared $count transaction${count == 1 ? '' : 's'}',
        '$payee बंद किया और $count लेन-देन से टैग हटाया',
        '$payee थांबवला आणि $count व्यवहारांमधून टॅग काढला',
        '$payee বন্ধ এবং $count টি লেনদেন থেকে ট্যাগ সরানো',
        '$payee ఆపి $count లావాదేవీల నుండి ట్యాగ్ తీసివేయబడింది',
        '$payee நிறுத்தப்பட்டு $count பரிவர்த்தனைகள் அகற்றப்பட்டன',
      );
  String get ruleRestored => _t('Rule restored', 'नियम वापस लाया गया',
      'नियम परत आणला', 'নিয়ম ফিরিয়ে আনা হয়েছে', 'నియమం పునరుద్ధరించబడింది', 'விதி மீட்டமைக்கப்பட்டது');
  String autoTaggedByRule(String payee) => _t(
        'Tagged automatically — every $payee transaction gets this tag.',
        'स्वतः टैग हुआ — $payee का हर लेन-देन यह टैग पाता है।',
        'आपोआप टॅग झाले — $payee चा प्रत्येक व्यवहार हा टॅग घेतो.',
        'স্বয়ংক্রিয়ভাবে ট্যাগ — $payee-এর প্রতিটি লেনদেন এই ট্যাগ পায়।',
        'స్వయంచాలకంగా ట్యాగ్ — $payee ప్రతి లావాదేవీకి ఈ ట్యాగ్ వస్తుంది.',
        'தானாக குறிச்சொல் — $payee-இன் ஒவ்வொரு பரிவர்த்தனையும் இதைப் பெறுகிறது.',
      );
  String get manageRule => _t('Manage', 'प्रबंधित करें', 'व्यवस्थापित करा',
      'পরিচালনা', 'నిర్వహించు', 'நிர்வகி');
  ...
  // Redesigned Wrapped poster (1.39): rhythm strip, insight grid, animated share.
  String get wVsLastMonth =>
      _t('vs last month', 'पिछले माह से', 'मागील महिन्यापेक्षा', 'গত মাসের তুলনায়', 'గత నెలతో పోలిస్తే', 'கடந்த மாதத்தை விட');
  String get wDailyRhythm =>
      _t('Spending rhythm', 'खर्च की लय', 'खर्चाची लय', 'খরচের ছন্দ', 'ఖర్చు లయ', 'செலவு தாளம்');
  String get wPeakLabel => _t('Peak', 'शिखर', 'शिखर', 'শীর্ষ', 'గరిష్ఠం', 'உச்சம்');
  String get wTopCategories =>
      _t('Top categories', 'शीर्ष श्रेणियाँ', 'आघाडीच्या श्रेणी', 'শীর্ষ বিভাগ', 'టాప్ వర్గాలు', 'சிறந்த வகைகள்');
  String get wNoSpendDays =>
      _t('No-spend days', 'बिना खर्च के दिन', 'खर्च नसलेले दिवस', 'খরচহীন দিন', 'ఖర్చు లేని రోజులు', 'செலவில்லா நாட்கள்');
  String wOfDays(int n) =>
      _t('of $n days', '$n दिनों में से', '$n दिवसांपैकी', '$n দিনের মধ্যে', '$n రోజులలో', '$n நாட்களில்');
  String get wBusiestDay =>
      _t('Busiest day', 'सबसे व्यस्त दिन', 'सर्वाधिक व्यस्त दिवस', 'ব্যস্ততম দিন', 'బిజీగా ఉన్న రోజు', 'பரபரப்பான நாள்');
  String nTxns(int n) =>
      _t('$n txns', '$n लेन-देन', '$n व्यवहार', '$n লেনদেন', '$n లావాదేవీలు', '$n பரிவர்த்தனைகள்');
  String nMerchants(int n) =>
      _t('$n merchants', '$n व्यापारी', '$n व्यापारी', '$n বিক্রেতা', '$n మర్చెంట్‌లు', '$n வணிகர்கள்');
  String get wTimeInApp =>
      _t('Time in app', 'ऐप में समय', 'ॲपमधील वेळ', 'অ্যাপে সময়', 'యాప్‌లో సమయం', 'ஆப்பில் நேரம்');
  String get wActiveDays =>
  ...
  String get wrappedAmountsOnNote => _t(
        ...
        'रक्कमा दिसत आहेत — तुम्ही जे शेअर कराल त्यात तुमचे खरे ₹ आकडे असतील.',
        'পরিমাণ দেখানো হচ্ছে — আপনি যা শেয়ার করবেন তাতে আপনার আসল ₹ সংখ্যা থাকবে।',
        'మొత్తాలు కనిపిస్తున్నాయి — మీరు షేర్ చేసే దేనిలోనైనా మీ నిజమైన ₹ సంఖ్యలు ఉంటాయి.',
        'தொகைகள் காட்டப்படுகின்றன — நீங்கள் பகிரும் எதிலும் உங்கள் உண்மையான ₹ எண்கள் இருக்கும்.',
      );
  String get wrappedPrivacyNote => _t(
        'Only percentages & names on the card — no amounts. Your finances stay private.',
        'कार्ड पर केवल प्रतिशत और नाम — कोई राशि नहीं। आपकी वित्तीय जानकारी निजी रहती है।',
        'कार्डवर फक्त टक्केवारी आणि नावे — रक्कम नाही. तुमची आर्थिक माहिती खाजगी राहते.',
        'কার্ডে শুধু শতাংশ ও নাম — কোনো পরিমাণ নেই। আপনার আর্থিক তথ্য ব্যক্তিগত থাকে।',
        'కార్డుపై శాతాలు & పేర్లు మాత్రమే — మొత్తాలు లేవు. మీ ఆర్థిక వివరాలు ప్రైవేట్‌గా ఉంటాయి.',
        'அட்டையில் சதவீதங்களும் பெயர்களும் மட்டுமே — தொகைகள் இல்லை. உங்கள் நிதித் தகவல் தனிப்பட்டதாக இருக்கும்.',
      );
  ...
  String streakRewardName(String id) {
    switch (id) {
      ...
      case 'theme_vellum':
        return _t('Vellum', 'वेलम', 'वेलम', 'ভেলাম', 'వెల్లమ్', 'வெல்லம்');
      case 'royal_pick_1':
      case 'royal_pick_2':
        return _t('Royal Unlock', 'रॉयल अनलॉक', 'रॉयल अनलॉक', 'রয়্যাল আনলক', 'రాయల్ అన్‌లాక్', 'ராயல் அன்லாக்');
      case 'freeze_pack_1':
        return _t('+1 Streak Freeze', '+1 स्ट्रीक फ़्रीज़', '+1 स्ट्रीक फ्रीझ', '+1 স্ট্রিক ফ্রিজ', '+1 స్ట్రీక్ ఫ్రీజ్', '+1 ஸ்ட்ரீக் ஃப்ரீஸ்');
      case 'freeze_pack_2':
      case 'freeze_pack_3':
      case 'freeze_pack_4':
        return _t('+2 Streak Freezes', '+2 स्ट्रीक फ़्रीज़', '+2 स्ट्रीक फ्रीझ', '+2 স্ট্রিক ফ্রিজ', '+2 స్ట్రీక్ ఫ్రీజ్‌లు', '+2 ஸ்ட்ரீக் ஃப்ரீஸ்கள்');
      default:
        return id;
    }
  }
  String streakRewardBlurb(String id) {
    switch (id) {
      ...
      case 'royal_pick_1':
        return _t(
          'Choose any one of the six royal avatars to unlock and equip. Unlocked at a 10-day streak.',
          'छह रॉयल अवतारों में से किसी एक को अनलॉक और धारण करने के लिए चुनें। 10-दिन की स्ट्रीक पर अनलॉक।',
          'सहा रॉयल अवतारांपैकी कोणताही एक अनलॉक करून धारण करण्यासाठी निवडा. 10-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'ছয়টি রয়্যাল অবতারের যেকোনো একটি আনলক ও পরিধান করতে বেছে নিন। 10-দিনের স্ট্রিকে আনলক।',
          'ఆరు రాయల్ అవతారాలలో ఏదైనా ఒకదాన్ని అన్‌లాక్ చేసి ధరించడానికి ఎంచుకోండి. 10-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'ஆறு ராயல் அவதாரங்களில் ஏதேனும் ஒன்றைத் திறந்து அணிய தேர்ந்தெடுங்கள். 10-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'royal_pick_2':
        return _t(
          'Choose another royal avatar to unlock, from the remaining five. Unlocked at a 24-day streak.',
          'बाकी बचे पाँच में से एक और रॉयल अवतार अनलॉक करने के लिए चुनें। 24-दिन की स्ट्रीक पर अनलॉक।',
          'उरलेल्या पाचांपैकी आणखी एक रॉयल अवतार अनलॉक करण्यासाठी निवडा. 24-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'বাকি পাঁচটির মধ্য থেকে আরও একটি রয়্যাল অবতার আনলক করতে বেছে নিন। 24-দিনের স্ট্রিকে আনলক।',
          'మిగిలిన ఐదింటిలో నుండి మరో రాయల్ అవతారాన్ని అన్‌లాక్ చేయడానికి ఎంచుకోండి. 24-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'மீதமுள்ள ஐந்தில் இருந்து மற்றொரு ராயல் அவதாரத்தைத் திறக்கத் தேர்ந்தெடுங்கள். 24-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'freeze_pack_1':
        return _t(
          'One extra Streak Freeze for your stash — insurance against a missed day. Unlocked at a 5-day streak.',
          'आपके भंडार के लिए एक अतिरिक्त स्ट्रीक फ़्रीज़ — छूटे दिन का बीमा। 5-दिन की स्ट्रीक पर अनलॉक।',
          'तुमच्या साठ्यासाठी एक जादा स्ट्रीक फ्रीझ — चुकलेल्या दिवसाचा विमा. 5-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'আপনার ভাণ্ডারের জন্য একটি বাড়তি স্ট্রিক ফ্রিজ — মিস হওয়া দিনের বিমা। 5-দিনের স্ট্রিকে আনলক।',
          'మీ నిల్వ కోసం ఒక అదనపు స్ట్రీక్ ఫ్రీజ్ — మిస్ అయిన రోజుకు బీమా. 5-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'உங்கள் இருப்புக்கு ஒரு கூடுதல் ஸ்ட்ரீக் ஃப்ரீஸ் — தவறிய நாளுக்கான காப்பீடு. 5-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'freeze_pack_2':
        return _t(
          'Two Streak Freezes at once — enough cover for a rough week. Unlocked at an 18-day streak.',
          'एक साथ दो स्ट्रीक फ़्रीज़ — मुश्किल हफ़्ते के लिए काफ़ी। 18-दिन की स्ट्रीक पर अनलॉक।',
          'एकाच वेळी दोन स्ट्रीक फ्रीझ — कठीण आठवड्यासाठी पुरेसे. 18-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'একসাথে দুটি স্ট্রিক ফ্রিজ — কঠিন সপ্তাহের জন্য যথেষ্ট। 18-দিনের স্ট্রিকে আনলক।',
          'ఒకేసారి రెండు స్ట్రీక్ ఫ్రీజ్‌లు — కష్టమైన వారానికి సరిపడా. 18-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'ஒரே நேரத்தில் இரண்டு ஸ்ட்ரீக் ஃப்ரீஸ்கள் — கடினமான வாரத்திற்குப் போதும். 18-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'freeze_pack_3':
        return _t(
          'Two more Streak Freezes for the long haul — a full stash keeps a month-long flame safe. Unlocked at a 36-day streak.',
          'लंबे सफ़र के लिए दो और स्ट्रीक फ़्रीज़ — भरा भंडार महीने भर की लौ को सुरक्षित रखता है। 36-दिन की स्ट्रीक पर अनलॉक।',
          'लांबच्या वाटचालीसाठी आणखी दोन स्ट्रीक फ्रीझ — भरलेला साठा महिनाभराची ज्योत सुरक्षित ठेवतो. 36-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'দীর্ঘ যাত্রার জন্য আরও দুটি স্ট্রিক ফ্রিজ — ভরা ভাণ্ডার মাসজোড়া শিখা নিরাপদ রাখে। 36-দিনের স্ট্রিকে আনলক।',
          'సుదీర్ఘ ప్రయాణానికి మరో రెండు స్ట్రీక్ ఫ్రీజ్‌లు — నిండు నిల్వ నెలరోజుల జ్వాలను సురక్షితంగా ఉంచుతుంది. 36-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'நீண்ட பயணத்திற்கு மேலும் இரண்டு ஸ்ட்ரீக் ஃப்ரீஸ்கள் — நிறைந்த இருப்பு மாதம் முழுவதுமான சுடரைப் பாதுகாக்கும். 36-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'freeze_pack_4':
        return _t(
          'Two Streak Freezes for the last stretch — cover for the hardest fortnight on the road. Unlocked at a 52-day streak.',
          'आख़िरी पड़ाव के लिए दो स्ट्रीक फ़्रीज़ — राह के सबसे कठिन पखवाड़े का सहारा। 52-दिन की स्ट्रीक पर अनलॉक।',
          'शेवटच्या टप्प्यासाठी दोन स्ट्रीक फ्रीझ — वाटेवरील सर्वात कठीण पंधरवड्याचा आधार. 52-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'শেষ ধাপের জন্য দুটি স্ট্রিক ফ্রিজ — পথের কঠিনতম পক্ষকালের আড়াল। 52-দিনের স্ট্রিকে আনলক।',
          'చివరి దశ కోసం రెండు స్ట్రీక్ ఫ్రీజ్‌లు — దారిలో అత్యంత కష్టమైన పక్షం రోజులకు రక్షణ. 52-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'கடைசிக் கட்டத்திற்கு இரண்டு ஸ்ட்ரீக் ஃப்ரீஸ்கள் — பாதையின் மிகக் கடினமான பதினைந்து நாட்களுக்கான பாதுகாப்பு. 52-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      case 'theme_vellum':
        return _t(
          'Your figures in deep ink on parchment, laid on near-black paper stock. Unlocked at a 60-day streak.',
          'लगभग काले काग़ज़ पर रखे चर्मपत्र पर गहरी स्याही में आपके आँकड़े। 60-दिन की स्ट्रीक पर अनलॉक।',
          'जवळपास काळ्या कागदावर ठेवलेल्या चर्मपत्रावर गडद शाईत तुमचे आकडे. 60-दिवसांच्या स्ट्रीकवर अनलॉक.',
          'প্রায়-কালো কাগজের উপর রাখা পার্চমেন্টে গাঢ় কালিতে আপনার হিসাব। 60-দিনের স্ট্রিকে আনলক।',
          'నలుపు రంగు కాగితంపై ఉంచిన పార్చ్‌మెంట్‌పై లోతైన సిరాతో మీ లెక్కలు. 60-రోజుల స్ట్రీక్ వద్ద అన్‌లాక్.',
          'கிட்டத்தட்ட கருப்புத் தாளின் மேல் வைத்த தோல்தாளில் அடர் மையில் உங்கள் கணக்குகள். 60-நாள் ஸ்ட்ரீக்கில் திறக்கப்படும்.',
        );
      default:
        return '';
    }
  ...
  String eliteAvatarName(String id) {
    switch (id) {
      case 'shadowblade':
        return _t('Shadow Blade', 'शैडो ब्लेड', 'शॅडो ब्लेड', 'শ্যাডো ব্লেড', 'షాడో బ్లేడ్', 'ஷேடோ பிளேட்');
      case 'crimsononi':
        return _t('Crimson Oni', 'क्रिमसन ओनी', 'क्रिमसन ओनी', 'ক্রিমসন ওনি', 'క్రిమ్సన్ ఓని', 'கிரிம்சன் ஓனி');
      case 'cyberronin':
        return _t('Cyber Ronin', 'साइबर रोनिन', 'सायबर रोनिन', 'সাইবার রোনিন', 'సైబర్ రోనిన్', 'சைபர் ரோனின்');
      case 'dragonlord':
        return _t('Dragon Lord', 'ड्रैगन लॉर्ड', 'ड्रॅगन लॉर्ड', 'ড্রাগন লর্ড', 'డ్రాగన్ లార్డ్', 'டிராகன் லார்ட்');
      case 'voidmonarch':
        return _t('Void Monarch', 'वॉयड मोनार्क', 'व्हॉइड मोनार्क', 'ভয়েড মোনার্ক', 'వాయిడ్ మోనార్క్', 'வாய்டு மோனார்க்');
      case 'phoenix':
        return _t('Eternal Phoenix', 'इटरनल फ़ीनिक्स', 'इटर्नल फिनिक्स', 'ইটারনাল ফিনিক্স', 'ఎటర్నల్ ఫీనిక్స్', 'எடர்னல் ஃபீனிக்ஸ்');
      case 'frostvalkyrie':
        return _t('Frost Valkyrie', 'फ़्रॉस्ट वाल्कीरी', 'फ्रॉस्ट वाल्कीरी', 'ফ্রস্ট ভালকিরি', 'ఫ్రాస్ట్ వాల్కీరీ', 'ஃப்ராஸ்ட் வால்கிரி');
      case 'astralsorceress':
        return _t('Astral Sorceress', 'एस्ट्रल सॉर्सेरेस', 'ॲस्ट्रल सॉर्सेरेस', 'অ্যাস্ট্রাল সরসেরেস', 'ఆస్ట్రల్ సోర్సెరెస్', 'ஆஸ்ட்ரல் சோர்செரஸ்');
      case 'solarpriestess':
        return _t('Solar Priestess', 'सोलर प्रीस्टेस', 'सोलर प्रीस्टेस', 'সোলার প্রিস্টেস', 'సోలార్ ప్రీస్టెస్', 'சோலார் ப்ரீஸ்டஸ்');
      case 'obsidianwarlord':
        return _t('Obsidian Warlord', 'ऑब्सीडियन वॉरलॉर्ड', 'ऑब्सिडियन वॉरलॉर्ड', 'অবসিডিয়ান ওয়ারলর্ড', 'అబ్సీడియన్ వార్‌లార్డ్', 'ஆப்சிடியன் வார்லார்ட்');
      default:
        return id;
    }
  }
  ...
  String get royalAvatarsDesc => _t(
        'Living avatars of the crown — they blink, wave, and bring their own court to your profile, in Light and Dark alike.',
        'ताज के जीवंत अवतार — पलक झपकाते, हाथ हिलाते, और लाइट व डार्क दोनों में आपकी प्रोफ़ाइल पर अपना दरबार लाते हैं।',
        'मुकुटाचे सजीव अवतार — डोळे मिचकावतात, हात हलवतात, आणि लाइट व डार्क दोन्हींत तुमच्या प्रोफाइलवर स्वतःचा दरबार आणतात.',
  ...
  String get royalCustomAnimationsTitle => _t(
        'Enable Custom Animations',
        'कस्टम एनिमेशन चालू करें',
        'कस्टम अ‍ॅनिमेशन सुरू करा',
        'কাস্টম অ্যানিমেশন চালু করুন',
        'కస్టమ్ యానిమేషన్‌లను ఆన్ చేయండి',
        'தனிப்பயன் அனிமேஷன்களை இயக்கு',
      );
  String get royalCustomAnimationsDesc => _t(
        'Let your royal roam the whole app — running, peeking and celebrating on screen. When off, it only waves and blinks from your profile.',
        'अपने रॉयल को पूरे ऐप में घूमने दें — दौड़ना, झाँकना और स्क्रीन पर जश्न मनाना। बंद होने पर, यह सिर्फ़ आपकी प्रोफ़ाइल से हाथ हिलाता और पलक झपकाता है।',
        'तुमच्या रॉयलला संपूर्ण अ‍ॅपमध्ये फिरू द्या — धावणे, डोकावणे आणि स्क्रीनवर जल्लोष. बंद असताना, तो फक्त तुमच्या प्रोफाइलवरून हात हलवतो आणि डोळे मिचकावतो.',
        'আপনার রয়্যালকে পুরো অ্যাপে ঘুরতে দিন — দৌড়ানো, উঁকি দেওয়া আর স্ক্রিনে উদযাপন। বন্ধ থাকলে, এটি শুধু আপনার প্রোফাইল থেকে হাত নাড়ে আর চোখ পিটপিট করে।',
        'మీ రాయల్ మొత్తం యాప్‌లో తిరగనివ్వండి — పరుగెత్తడం, తొంగిచూడటం, స్క్రీన్‌పై సంబరాలు. ఆఫ్‌లో ఉంటే, అది కేవలం మీ ప్రొఫైల్ నుండి చేయి ఊపి కళ్ళు ఆర్పుతుంది.',
        'உங்கள் ராயல் முழு ஆப்பிலும் உலாவட்டும் — ஓடுதல், எட்டிப்பார்த்தல், திரையில் கொண்டாட்டம். ஆஃப் செய்தால், அது உங்கள் சுயவிவரத்திலிருந்து கை அசைத்து கண் சிமிட்டும் மட்டுமே.',
      );

  // ── Royalty · match-app-icon toggle ────────────────────────────────────
  String get royalAppIconTitle => _t(
        'Match app icon to my royal',
        'ऐप आइकन को मेरे रॉयल से मिलाएँ',
        'अ‍ॅप आयकन माझ्या रॉयलशी जुळवा',
        'অ্যাপ আইকন আমার রয়্যালের সাথে মেলান',
        'యాప్ ఐకాన్‌ను నా రాయల్‌కు సరిపోల్చండి',
        'ஆப் ஐகானை என் ராயலுடன் பொருத்து',
      );
  String get royalAppIconDesc => _t(
        'Your home-screen icon follows your equipped royal.',
        'आपका होम-स्क्रीन आइकन आपके पहने रॉयल के अनुसार बदलता है।',
        'तुमचा होम-स्क्रीन आयकन तुम्ही घातलेल्या रॉयलनुसार बदलतो.',
        'আপনার হোম-স্ক্রিন আইকন আপনার পরা রয়্যাল অনুসরণ করে।',
        'మీ హోమ్-స్క్రీన్ ఐకాన్ మీరు ధరించిన రాయల్‌ను అనుసరిస్తుంది.',
        'உங்கள் முகப்புத் திரை ஐகான் நீங்கள் அணிந்த ராயலைப் பின்பற்றும்.',
      );
  String get royalAppIconRestartTitle => _t(
        'Change app icon?',
        'ऐप आइकन बदलें?',
        'अ‍ॅप आयकन बदलायचे?',
        'অ্যাপ আইকন বদলাবেন?',
  ...
  String get royalAppIconRestartBody => _t(
        'Budgetify will restart to update its home-screen icon. It comes straight back — your royal is already saved.',
        'होम-स्क्रीन आइकन बदलने के लिए Budgetify फिर से शुरू होगा। यह तुरंत वापस आ जाएगा — आपका रॉयल पहले ही सहेजा जा चुका है।',
        'होम-स्क्रीन आयकन बदलण्यासाठी Budgetify पुन्हा सुरू होईल. ते लगेच परत येईल — तुमचा रॉयल आधीच जतन झाला आहे.',
        'হোম-স্ক্রিন আইকন বদলাতে Budgetify আবার চালু হবে। এটি সঙ্গে সঙ্গে ফিরে আসবে — আপনার রয়্যাল ইতিমধ্যে সংরক্ষিত।',
        'హోమ్-స్క్రీన్ ఐకాన్‌ను మార్చడానికి Budgetify పునఃప్రారంభమవుతుంది. వెంటనే తిరిగి వస్తుంది — మీ రాయల్ ఇప్పటికే సేవ్ అయింది.',
        'முகப்புத் திரை ஐகானை மாற்ற Budgetify மீண்டும் தொடங்கும். உடனே திரும்பி வரும் — உங்கள் ராயல் ஏற்கனவே சேமிக்கப்பட்டது.',
      );
  String get royalAppIconRestartConfirm => _t(
        'Restart & apply',
        'पुनः आरंभ करें और लागू करें',
        'पुन्हा सुरू करा आणि लागू करा',
        'পুনরায় চালু করে প্রয়োগ করুন',
        'పునఃప్రారంభించి వర్తింపజేయి',
        'மீண்டும் தொடங்கி பயன்படுத்து',
      );
  ...
  String royalAvatarName(String id) {
    switch (id) {
      ...
      case 'prince':
        return _t('The Prince', 'द प्रिंस', 'द प्रिन्स', 'দ্য প্রিন্স', 'ద ప్రిన్స్', 'தி பிரின்ஸ்');
      case 'darkprince':
        return _t('The Dark Prince', 'द डार्क प्रिंस', 'द डार्क प्रिन्स', 'দ্য ডার্ক প্রিন্স', 'ద డార్క్ ప్రిన్స్', 'தி டார்க் பிரின்ஸ்');
      case 'princess':
  ...
  /// One-line court lore shown on the royal's description sheet.
  String royalAvatarLore(String id) {
    switch (id) {
      case 'sovereign':
        return _t(
          'The founding king — crimson robes, ermine collar, a crown of rubies.',
          'संस्थापक राजा — क्रिमसन वस्त्र, फ़र कॉलर, माणिक का मुकुट।',
          'संस्थापक राजा — क्रिमसन वस्त्रे, फर कॉलर, माणकांचा मुकुट.',
          'প্রতিষ্ঠাতা রাজা — ক্রিমসন পোশাক, ফার কলার, চুনির মুকুট।',
          'స్థాపక రాజు — క్రిమ్సన్ వస్త్రాలు, ఫర్ కాలర్, కెంపుల కిరీటం.',
          'நிறுவனர் அரசர் — கிரிம்சன் அங்கி, ஃபர் காலர், மாணிக்க கிரீடம்.',
        );
      case 'empress':
        return _t(
          'The raven-haired matriarch — sapphire tiara, violet gown, quiet command.',
          'श्याम-केशी साम्राज्ञी — नीलम टियारा, बैंगनी गाउन, शांत प्रभुत्व।',
          'कृष्णकेशी सम्राज्ञी — नीलम टियारा, जांभळा गाउन, शांत अधिकार.',
          'কালো কেশের সম্রাজ্ঞী — নীলকান্ত টায়রা, বেগুনি গাউন, শান্ত কর্তৃত্ব।',
          'నల్లని కేశాల సామ్రాజ్ఞి — నీలమణి కిరీటం, వైలెట్ గౌను, నిశ్శబ్ద అధికారం.',
          'கருங்கூந்தல் பேரரசி — நீலக்கல் டயரா, ஊதா கவுன், அமைதியான ஆணை.',
        );
      case 'prince':
        return _t(
          'The heir in gilded plate, sword in hand — radiant, eager, golden.',
          'स्वर्ण कवच में उत्तराधिकारी, हाथ में तलवार — तेजस्वी, उत्सुक, सुनहरा।',
          'सोनेरी चिलखतातील वारस, हाती तलवार — तेजस्वी, उत्सुक, सुवर्ण.',
          'সোনালি বর্মে উত্তরাধিকারী, হাতে তরবারি — দীপ্তিমান, আগ্রহী, সোনালি।',
          'బంగారు కవచంలో వారసుడు, చేతిలో ఖడ్గం — ప్రకాశవంతం, ఉత్సాహం, స్వర్ణం.',
          'பொன் கவசத்தில் வாரிசு, கையில் வாள் — ஒளிரும், ஆர்வம், தங்கம்.',
        );
      case 'darkprince':
        return _t(
          'The exiled brother — black plate, ember eyes, a studded war club.',
          'निर्वासित भाई — काला कवच, अंगारे-सी आँखें, कीलदार गदा।',
          'निर्वासित भाऊ — काळे चिलखत, निखाऱ्यासारखे डोळे, खिळेदार गदा.',
          'নির্বাসিত ভাই — কালো বর্ম, অঙ্গার চোখ, পেরেকযুক্ত গদা।',
          'బహిష్కృత సోదరుడు — నల్ల కవచం, నిప్పుకణాల కళ్ళు, ములుకుల గద.',
          'நாடு கடத்தப்பட்ட சகோதரன் — கருப்பு கவசம், தீக்கங்கு கண்கள், ஆணி பதித்த கதை.',
        );
      case 'princess':
        return _t(
          'Elegance itself — a blush-gem tiara, pearls, and a rose gown.',
          'स्वयं लालित्य — गुलाबी रत्न टियारा, मोती, और गुलाबी गाउन।',
          'साक्षात लालित्य — गुलाबी रत्न टियारा, मोती, आणि गुलाबी गाउन.',
          'সৌন্দর্যের প্রতিমূর্তি — গোলাপি রত্নের টায়রা, মুক্তা, গোলাপি গাউন।',
      ...
      case 'royalmedic':
        return _t(
          ...
          'రాజవైద్యురాలు — జీవన పచ్చల శిలువ, అలుపెరగని చేతులు.',
          'அரசவை மருத்துவர் — வாழ்வின் மரகத சிலுவை, ஓயாத கரங்கள்.',
        );
      default:
        return '';
    }
  ...
  /// The per-royal app-wide theme toggle label, e.g. the Dark Prince's
  /// "Apply app-wide Blood theme".
  String royalThemeToggle(String id) {
    switch (id) {
      case 'sovereign':
        return _t('Apply app-wide Crimson theme', 'पूरे ऐप में क्रिमसन थीम लगाएँ',
            'संपूर्ण ॲपला क्रिमसन थीम लावा', 'অ্যাপ জুড়ে ক্রিমসন থিম লাগান',
            'యాప్ అంతటా క్రిమ్సన్ థీమ్ వర్తించు', 'ஆப் முழுவதும் கிரிம்சன் தீம் பயன்படுத்து');
      case 'empress':
        return _t('Apply app-wide Violet theme', 'पूरे ऐप में वायलेट थीम लगाएँ',
            'संपूर्ण ॲपला व्हायलेट थीम लावा', 'অ্যাপ জুড়ে ভায়োলেট থিম লাগান',
            'యాప్ అంతటా వైలెట్ థీమ్ వర్తించు', 'ஆப் முழுவதும் வயலட் தீம் பயன்படுத்து');
      case 'prince':
        return _t('Apply app-wide Gilded theme', 'पूरे ऐप में स्वर्णिम थीम लगाएँ',
            'संपूर्ण ॲपला सुवर्ण थीम लावा', 'অ্যাপ জুড়ে সোনালি থিম লাগান',
            'యాప్ అంతటా స్వర్ణ థీమ్ వర్తించు', 'ஆப் முழுவதும் பொன் தீம் பயன்படுத்து');
      case 'darkprince':
        return _t('Apply app-wide Blood theme', 'पूरे ऐप में ब्लड थीम लगाएँ',
            'संपूर्ण ॲपला ब्लड थीम लावा', 'অ্যাপ জুড়ে ব্লাড থিম লাগান',
            'యాప్ అంతటా బ్లడ్ థీమ్ వర్తించు', 'ஆப் முழுவதும் பிளட் தீம் பயன்படுத்து');
      case 'princess':
        return _t('Apply app-wide Blush theme', 'पूरे ऐप में ब्लश थीम लगाएँ',
            'संपूर्ण ॲपला ब्लश थीम लावा', 'অ্যাপ জুড়ে ব্লাশ থিম লাগান',
            'యాప్ అంతటా బ్లష్ థీమ్ వర్తించు', 'ஆப் முழுவதும் பிளஷ் தீம் பயன்படுத்து');
      case 'royalmedic':
  ...
  /// The both-modes promise, shown as a pill on the description sheet.
  /// Every court dresses Light and Dark alike — bright regalia on the dark
  /// canvas, its deeper shade on ivory — so no royal is a mode-locked pick.
  String get royalDualModeNote => _t(
        'Reigns in Light and Dark — the court re-tints to the theme you use.',
        'लाइट और डार्क, दोनों में राज — दरबार आपकी थीम के अनुसार रंग बदलता है।',
        'लाइट आणि डार्क, दोन्हींत राज्य — दरबार तुमच्या थीमनुसार रंग बदलतो.',
        'লাইট ও ডার্ক—দুয়েতেই রাজত্ব — দরবার আপনার থিম অনুযায়ী রং বদলায়।',
        'లైట్, డార్క్ రెండింటిలోనూ పాలన — మీ థీమ్‌కు తగ్గట్టు ఆస్థానం రంగు మారుతుంది.',
        'லைட், டார்க் இரண்டிலும் ஆட்சி — உங்கள் தீமுக்கேற்ப அரசவை நிறம் மாறும்.',
      );

  /// Offer a one-tap hop to the other primary theme, to see the same court
  /// in the other mode (or, from a reward theme, to bring the dress back).
  String royalSwitchMode(bool toLight) => toLight
      ? _t('See it in the Light theme', 'लाइट थीम में देखें',
          'लाइट थीममध्ये पहा', 'লাইট থিমে দেখুন',
          'లైట్ థీమ్‌లో చూడండి', 'லைட் தீமில் பாருங்கள்')
      : _t('See it in the Dark theme', 'डार्क थीम में देखें',
          'डार्क थीममध्ये पहा', 'ডার্ক থিমে দেখুন',
          'డార్క్ థీమ్‌లో చూడండి', 'டார்க் தீமில் பாருங்கள்');

  /// Confirmation that the equipped court is dressing the theme in use.
  String royalCourtLive(bool onLight) => onLight
      ? _t('Its court is live on your Light theme',
          'इसका दरबार आपकी लाइट थीम पर सक्रिय है',
          'याचा दरबार तुमच्या लाइट थीमवर सक्रिय आहे',
          'এর দরবার আপনার লাইট থিমে সক্রিয়',
          'దీని ఆస్థానం మీ లైట్ థీమ్‌లో ప్రత్యక్షం',
          'இதன் அரசவை உங்கள் லைட் தீமில் இயங்குகிறது')
      : _t('Its court is live on your Dark theme',
          'इसका दरबार आपकी डार्क थीम पर सक्रिय है',
          'याचा दरबार तुमच्या डार्क थीमवर सक्रिय आहे',
          'এর দরবার আপনার ডার্ক থিমে সক্রিয়',
          'దీని ఆస్థానం మీ డార్క్ థీమ్‌లో ప్రత్యక్షం',
          'இதன் அரசவை உங்கள் டார்க் தீமில் இயங்குகிறது');

  String get equipRoyal =>
      _t('Equip', 'धारण करें', 'धारण करा', 'পরিধান করুন', 'ధరించు', 'அணி');
  String get equippedRoyal =>
      _t('Equipped', 'धारण किया हुआ', 'धारण केलेले', 'পরিহিত', 'ధరించారు', 'அணிந்துள்ளது');

  // ── Royal unlocks (earned from streak picks) ───────────────────────────────
  /// Section status when the user has royal picks to spend.
  String royalPicksAvailable(int n) => _t(
        n == 1
            ? 'You’ve earned 1 royal pick — tap any locked royal to unlock it.'
            : 'You’ve earned $n royal picks — tap any locked royal to unlock it.',
        'आपने $n रॉयल पिक कमाई — किसी भी लॉक रॉयल को अनलॉक करने के लिए टैप करें।',
        'तुम्ही $n रॉयल पिक कमावले — कोणताही लॉक रॉयल अनलॉक करण्यासाठी टॅप करा.',
        'আপনি $n রয়্যাল পিক অর্জন করেছেন — যেকোনো লক করা রয়্যালে ট্যাপ করে আনলক করুন।',
        'మీరు $n రాయల్ పిక్‌లు సంపాదించారు — ఏదైనా లాక్ చేసిన రాయల్‌ను అన్‌లాక్ చేయడానికి ట్యాప్ చేయండి.',
  ...
  String royalUnlockedToast(String name) => _t(
        '$name unlocked! Equipped and ready.',
        '$name अनलॉक हो गया! धारण कर लिया गया।',
        '$name अनलॉक झाला! धारण केला.',
  ...
  String get royalPickRoadUnlocked => _t(
        'Choose your royal in the Royalty section of your profile avatar.',
        'अपने प्रोफ़ाइल अवतार के Royalty सेक्शन में अपना रॉयल चुनें।',
        'तुमच्या प्रोफाइल अवताराच्या Royalty विभागात तुमचा रॉयल निवडा.',
        'আপনার প্রোফাইল অবতারের Royalty বিভাগে আপনার রয়্যাল বেছে নিন।',
        'మీ ప్రొఫైల్ అవతార్‌లోని Royalty విభాగంలో మీ రాయల్‌ను ఎంచుకోండి.',
        'உங்கள் சுயவிவர அவதாரத்தின் Royalty பிரிவில் உங்கள் ராயலைத் தேர்ந்தெடுங்கள்.',
      );
  ...
  String titleName(String id) {
    switch (id) {
      ...
      case 'masterbudgeter':
        return _t('Master Budgeter', 'मास्टर बजटर', 'मास्टर बजेटर', 'মাস্টার বাজেটার', 'మాస్టర్ బడ్జెటర్', 'மாஸ்டர் பட்ஜெட்டர்');
      default:
        return id;
    }
  }
  String titleBlurb(String id) {
    switch (id) {
      ...
      case 'masterbudgeter':
        return _t(
          'Unlock every medal and every other title to claim the final crown.',
          'अंतिम ताज पाने के लिए हर मेडल और हर दूसरा खिताब अनलॉक करें।',
          'अंतिम मुकुट मिळवण्यासाठी प्रत्येक पदक आणि इतर प्रत्येक किताब अनलॉक करा.',
          'চূড়ান্ত মুকুট পেতে প্রতিটি মেডেল ও অন্য প্রতিটি খেতাব আনলক করুন।',
          'తుది కిరీటం పొందడానికి ప్రతి పతకాన్ని మరియు మిగతా ప్రతి బిరుదును అన్‌లాక్ చేయండి.',
          'இறுதி கிரீடத்தைப் பெற ஒவ்வொரு பதக்கத்தையும் மற்ற ஒவ்வொரு பட்டத்தையும் திறக்கவும்.',
        );
      default:
        return '';
    }
  ...
  String gamiUnit(String unit) {
    switch (unit) {
      ...
      case 'unlocks':
        return _t('unlocks', 'अनलॉक', 'अनलॉक', 'আনলক', 'అన్‌లాక్‌లు', 'திறப்புகள்');
      default:
        return unit;
    }
  }
  ...
  String get tutSettingsGamifiedBody => _t(
        'Daily streaks, badge ladders, rare titles, royal avatars and a shareable profile — earned just by tracking, all offline. It’s on by default: your avatar sits top-right on Home, and that avatar is the Rewards hub. Turn it off here anytime.',
        'रोज़ की स्ट्रीक, बैज लैडर, दुर्लभ खिताब, रॉयल अवतार और शेयर करने लायक प्रोफ़ाइल — सिर्फ़ ट्रैक करते रहने से, पूरी तरह ऑफ़लाइन। यह डिफ़ॉल्ट रूप से ऑन है: होम पर ऊपर-दाएँ आपका अवतार दिखता है, और वही अवतार Rewards हब है। इसे यहाँ कभी भी बंद करें।',
        'रोजची स्ट्रीक, बॅज शिड्या, दुर्मीळ किताब, रॉयल अवतार आणि शेअर करण्याजोगी प्रोफाइल — फक्त ट्रॅक करत राहिल्याने, पूर्णपणे ऑफलाइन. हे डीफॉल्टनुसार सुरू आहे: होमवर वर-उजवीकडे तुमचा अवतार दिसतो, आणि तोच अवतार Rewards हब आहे. इथे कधीही बंद करा.',
        'দৈনিক স্ট্রিক, ব্যাজ ল্যাডার, বিরল খেতাব, রয়্যাল অবতার আর শেয়ার-যোগ্য প্রোফাইল — শুধু ট্র্যাক করলেই, সম্পূর্ণ অফলাইনে। এটি ডিফল্টভাবে চালু: হোমের ওপরে ডানদিকে আপনার অবতার থাকে, আর সেই অবতারই Rewards হাব। এটি এখানে যেকোনো সময় বন্ধ করুন।',
        'రోజువారీ స్ట్రీక్‌లు, బ్యాడ్జ్ నిచ్చెనలు, అరుదైన బిరుదులు, రాయల్ అవతారాలు మరియు షేర్ చేయదగిన ప్రొఫైల్ — కేవలం ట్రాక్ చేయడం ద్వారానే సంపాదించబడతాయి, అన్నీ ఆఫ్‌లైన్‌లో. ఇది డిఫాల్ట్‌గా ఆన్‌లో ఉంటుంది: మీ అవతార్ హోమ్‌పై కుడి-పైన ఉంటుంది, ఆ అవతారే Rewards హబ్. దీన్ని ఇక్కడ ఎప్పుడైనా ఆఫ్ చేయండి.',
        'தினசரி ஸ்ட்ரீக்குகள், பேட்ஜ் ஏணிகள், அரிய பட்டங்கள், ராயல் அவதாரங்கள் மற்றும் பகிரக்கூடிய சுயவிவரம் — வெறும் கண்காணிப்பதன் மூலமே சம்பாதிக்கப்படுகின்றன, அனைத்தும் ஆஃப்லைனில். இது இயல்பாகவே இயக்கத்தில் உள்ளது: உங்கள் அவதாரம் முகப்பில் மேல்-வலதில் இருக்கும், அந்த அவதாரமே Rewards ஹப். இதை இங்கே எப்போது வேண்டுமானாலும் அணைக்கலாம்.',
      );
  ...
  String get plusTagline => _t(
        ...
        'जो पसंद है, सब बनाए रखें',
        'तुम्हाला आवडणारे सर्व ठेवा',
        'যা ভালোবাসেন সব রাখুন',
  ...
  String get plusFeaturesHeader => _t(
        'Everything in Plus',
        'Plus में सब कुछ',
        'Plus मध्ये सर्व काही',
        'Plus-এ সবকিছু',
        'Plus లో అన్నీ',
        'Plus இல் அனைத்தும்',
      );
  String get plusFeatCategoryBudgets => _t(
        'Category-wise budgets & alerts',
        'श्रेणी-वार बजट और अलर्ट',
        'श्रेणीनुसार बजेट व अलर्ट',
        'ক্যাটাগরি-ভিত্তিক বাজেট ও অ্যালার্ট',
        'వర్గాల వారీ బడ్జెట్‌లు & అలర్ట్‌లు',
        'வகைவாரி பட்ஜெட்கள் & எச்சரிக்கைகள்',
      );
  String get plusFeatSpendAlerts => _t(
        'Instant debit & credit alerts',
        'तुरंत डेबिट व क्रेडिट अलर्ट',
        'तत्काळ डेबिट व क्रेडिट अलर्ट',
        'তাৎক্ষণিক ডেবিট ও ক্রেডিট অ্যালার্ট',
        'తక్షణ డెబిట్ & క్రెడిట్ అలర్ట్‌లు',
        'உடனடி டெபிட் & கிரெடிட் எச்சரிக்கைகள்',
      );
  String get plusFeatRecurring => _t(
        'Bill & subscription reminders',
        'बिल और सब्सक्रिप्शन रिमाइंडर',
        'बिल व सबस्क्रिप्शन रिमाइंडर',
        'বিল ও সাবস্ক্রিপশন রিমাইন্ডার',
        'బిల్ & సబ్‌స్క్రిప్షన్ రిమైండర్‌లు',
        'பில் & சந்தா நினைவூட்டல்கள்',
      );
  String get plusFeatInvestments => _t(
        'Investment reminders',
        'निवेश रिमाइंडर',
        'गुंतवणूक रिमाइंडर',
        'বিনিয়োগ রিমাইন্ডার',
        'పెట్టుబడి రిమైండర్‌లు',
        'முதலீட்டு நினைவூட்டல்கள்',
      );
  String get plusFeatTagging => _t(
        'One-tap tagging across transactions',
        'सभी लेन-देन पर वन-टैप टैगिंग',
        'सर्व व्यवहारांवर वन-टॅप टॅगिंग',
  ...
  String get plusPerMonth => _t('per month', 'प्रति माह', 'प्रति महिना', 'প্রতি মাসে', 'నెలకు', 'மாதத்திற்கு');
  String get plusPerYear => _t('per year', 'प्रति वर्ष', 'प्रति वर्ष', 'প্রতি বছরে', 'సంవత్సరానికి', 'வருடத்திற்கு');
  String get plusOneTime => _t(
        'one-time, forever',
        'एक बार, हमेशा के लिए',
        'एकदाच, कायमचे',
        'একবারই, চিরকালের জন্য',
        'ఒక్కసారి, ఎప్పటికీ',
        'ஒருமுறை, என்றென்றும்',
      );
  String get plusBestValue => _t('Best value', 'सर्वश्रेष्ठ मूल्य', 'सर्वोत्तम मूल्य', 'সেরা মূল্য', 'ఉత్తమ విలువ', 'சிறந்த மதிப்பு');
  String get plusMostLoved => _t('No subscription', 'कोई सब्सक्रिप्शन नहीं', 'सबस्क्रिप्शन नाही', 'কোনো সাবস্ক্রিপশন নেই', 'సబ్‌స్క్రిప్షన్ లేదు', 'சந்தா இல்லை');
  String plusContinueCta(String price) => _t(
        'Continue — $price',
        'जारी रखें — $price',
        'पुढे जा — $price',
        'এগিয়ে যান — $price',
  ...
  String get plusRestore => _t(
        'Restore purchases',
        'खरीदारी बहाल करें',
        'खरेदी पुनर्संचयित करा',
        'কেনাকাটা পুনরুদ্ধার করুন',
        'కొనుగోళ్లను పునరుద్ధరించండి',
        'வாங்கியவற்றை மீட்டெடு',
      );
  String get plusStoreUnavailable => _t(
        'Purchases open soon — Google Play billing is on its way.',
        'खरीदारी जल्द शुरू होगी — Google Play बिलिंग आ रही है।',
        'खरेदी लवकरच सुरू होईल — Google Play बिलिंग येत आहे.',
        'কেনাকাটা শীঘ্রই চালু হবে — Google Play বিলিং আসছে।',
        'కొనుగోళ్లు త్వరలో తెరుచుకుంటాయి — Google Play బిల్లింగ్ వస్తోంది.',
        'வாங்குதல் விரைவில் தொடங்கும் — Google Play பில்லிங் வருகிறது.',
      );
  String get plusRestoreNone => _t(
        'No purchases found to restore.',
        'बहाल करने के लिए कोई खरीदारी नहीं मिली।',
        'पुनर्संचयित करण्यासाठी खरेदी आढळली नाही.',
        'পুনরুদ্ধারের জন্য কোনো কেনাকাটা পাওয়া যায়নি।',
        'పునరుద్ధరించడానికి కొనుగోళ్లు కనబడలేదు.',
        'மீட்டெடுக்க வாங்கியவை எதுவும் இல்லை.',
      );
  String plusRestoreDone(int n) => _t(
        'Restored $n purchase${n == 1 ? '' : 's'}. Welcome back!',
        '$n खरीदारी बहाल हुई। वापसी पर स्वागत है!',
        '$n खरेदी पुनर्संचयित झाली. पुन्हा स्वागत!',
  ...
  String get plusActive => _t(
        ...
        'Plus सक्रिय आहे — धन्यवाद!',
        'Plus সক্রিয় — ধন্যবাদ!',
  ...
  String get plusFootnote => _t(
        ...
        'Google Play द्वारे एकदाच बिलिंग. खाते नाही, साइन-अप नाही — खरेदी तुमच्या Google खात्याशी राहते आणि री-इंस्टॉलवर पुनर्संचयित होते.',
        'Google Play-এর মাধ্যমে একবার বিল। কোনো অ্যাকাউন্ট নেই, সাইন-আপ নেই — কেনাকাটা আপনার Google অ্যাকাউন্টে থাকে এবং রিইনস্টলে ফিরে আসে।',
        'Google Play ద్వారా ఒకసారి బిల్లింగ్. ఖాతా లేదు, సైన్-అప్ లేదు — కొనుగోళ్లు మీ Google ఖాతాతో ఉంటాయి, రీఇన్‌స్టాల్‌లో పునరుద్ధరించబడతాయి.',
        'Google Play வழியாக ஒருமுறை பில்லிங். கணக்கு இல்லை, பதிவு இல்லை — வாங்கியவை உங்கள் Google கணக்குடன் இருக்கும், மறு நிறுவலில் மீட்டெடுக்கப்படும்.',
      );
}
