...
class AppStrings {
  ...
  String get royalAppIconRestartBody => _t(
        'Budgetify needs to close to update its home-screen icon. Reopen it to finish — your royal is already saved.',
        'होम-स्क्रीन आइकन बदलने के लिए Budgetify को बंद होना होगा। इसे फिर से खोलें — आपका रॉयल पहले ही सहेजा जा चुका है।',
        'होम-स्क्रीन आयकन बदलण्यासाठी Budgetify बंद व्हावे लागेल. ते पुन्हा उघडा — तुमचा रॉयल आधीच जतन झाला आहे.',
        'হোম-স্ক্রিন আইকন বদলাতে Budgetify বন্ধ হতে হবে। আবার খুলুন — আপনার রয়্যাল ইতিমধ্যে সংরক্ষিত।',
        'హోమ్-స్క్రీన్ ఐకాన్‌ను మార్చడానికి Budgetify మూసివేయాలి. మళ్లీ తెరవండి — మీ రాయల్ ఇప్పటికే సేవ్ అయింది.',
        'முகப்புத் திரை ஐகானை மாற்ற Budgetify மூட வேண்டும். மீண்டும் திறக்கவும் — உங்கள் ராயல் ஏற்கனவே சேமிக்கப்பட்டது.',
      );
  String get royalAppIconRestartConfirm => _t(
        'Close & apply',
        'बंद करें और लागू करें',
        'बंद करा आणि लागू करा',
        'বন্ধ করে প্রয়োগ করুন',
        'మూసివేసి వర్తింపజేయి',
        'மூடி பயன்படுத்து',
      );
