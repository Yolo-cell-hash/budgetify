...
class AppStrings {
  ...
  // ── Settings · App notification capture ───────────────────────────────────
  String get notifCaptureSection => _t('Payment App Alerts', 'पेमेंट ऐप अलर्ट',
      'पेमेंट अॅप अलर्ट', 'পেমেন্ট অ্যাপ অ্যালার্ট', 'పేమెంట్ యాప్ అలర్ట్‌లు', 'பேமெண்ட் ஆப் எச்சரிக்கைகள்');
  String get notifCaptureTitle => _t(
        'Capture from payment apps',
        'पेमेंट ऐप्स से कैप्चर करें',
        'पेमेंट अॅप्समधून कॅप्चर करा',
        'পেমেন্ট অ্যাপ থেকে ক্যাপচার করুন',
        'పేమెంట్ యాప్‌ల నుండి క్యాప్చర్ చేయండి',
        'பேமெண்ட் ஆப்களிலிருந்து பதிவு செய்யவும்',
      );
  String get notifCaptureOffDesc => _t(
        'Off — transactions come from SMS only',
        'बंद — लेन-देन केवल SMS से आते हैं',
        'बंद — व्यवहार फक्त SMS मधून येतात',
        'বন্ধ — লেনদেন শুধুমাত্র SMS থেকে আসে',
        'ఆఫ్ — లావాదేవీలు SMS నుండి మాత్రమే వస్తాయి',
        'ஆஃப் — பரிவர்த்தனைகள் SMS மூலம் மட்டுமே',
      );
  String get notifCaptureOnDesc => _t(
        'Catching payments that no longer come as SMS',
        'वे पेमेंट पकड़ रहा है जो अब SMS से नहीं आते',
        'आता SMS ने न येणारी पेमेंट पकडत आहे',
        'যে পেমেন্ট আর SMS-এ আসে না তা ধরা হচ্ছে',
        'ఇకపై SMSగా రాని చెల్లింపులను పట్టుకుంటోంది',
        'இனி SMS ஆக வராத பணப்பரிமாற்றங்களைப் பிடிக்கிறது',
      );
  String get notifCaptureNeedsAccess => _t(
        'Action needed — grant notification access',
        'कार्रवाई आवश्यक — नोटिफ़िकेशन एक्सेस दें',
        'कृती आवश्यक — नोटिफिकेशन अॅक्सेस द्या',
        'পদক্ষেপ প্রয়োজন — নোটিফিকেশন অ্যাক্সেস দিন',
        'చర్య అవసరం — నోటిఫికేషన్ యాక్సెస్ ఇవ్వండి',
        'நடவடிக்கை தேவை — அறிவிப்பு அணுகல் வழங்கவும்',
      );
  String get notifCaptureExplainTitle => _t(
        'Catch what SMS misses',
        'जो SMS से छूट जाए, उसे पकड़ें',
        'SMS मधून सुटते ते पकडा',
        'SMS যা মিস করে তা ধরুন',
        'SMS మిస్ చేసేది పట్టుకోండి',
        'SMS தவறவிடுவதைப் பிடிக்கவும்',
      );
  String get notifCaptureExplainBody => _t(
        'Banks are switching off SMS for small UPI payments. The payment app\'s own alert still records them — Budgetify can read those alerts and log the transaction, fully on this phone, like everything else.',
        'बैंक छोटे UPI पेमेंट के SMS बंद कर रहे हैं। पेमेंट ऐप का अपना अलर्ट उन्हें दर्ज करता है — Budgetify वे अलर्ट पढ़कर लेन-देन लिख सकता है, बाकी सब की तरह पूरी तरह इसी फ़ोन पर।',
        'बँका लहान UPI पेमेंटचे SMS बंद करत आहेत. पेमेंट अॅपचा स्वतःचा अलर्ट ते नोंदवतो — Budgetify ते अलर्ट वाचून व्यवहार नोंदवू शकते, इतर सर्व गोष्टींप्रमाणे पूर्णपणे याच फोनवर.',
        'ব্যাংকগুলি ছোট UPI পেমেন্টের SMS বন্ধ করছে। পেমেন্ট অ্যাপের নিজস্ব অ্যালার্ট সেগুলি রেকর্ড করে — Budgetify সেই অ্যালার্ট পড়ে লেনদেন লিখতে পারে, বাকি সবকিছুর মতো সম্পূর্ণ এই ফোনেই।',
        'చిన్న UPI చెల్లింపులకు బ్యాంకులు SMS ఆపేస్తున్నాయి. పేమెంట్ యాప్ సొంత అలర్ట్ వాటిని నమోదు చేస్తుంది — Budgetify ఆ అలర్ట్‌లను చదివి లావాదేవీ రాయగలదు, మిగతా అన్నింటిలాగే పూర్తిగా ఈ ఫోన్‌లోనే.',
        'சிறிய UPI பணப்பரிமாற்றங்களுக்கு வங்கிகள் SMS நிறுத்துகின்றன. பேமெண்ட் ஆப்பின் சொந்த எச்சரிக்கை அவற்றைப் பதிவு செய்கிறது — Budgetify அந்த எச்சரிக்கைகளைப் படித்து பரிவர்த்தனையை எழுத முடியும், மற்ற எல்லாவற்றையும் போல முழுவதுமாக இந்த ஃபோனிலேயே.',
      );
  String get notifCaptureOnlyTheseApps => _t(
        'Only these apps are ever read:',
        'केवल इन्हीं ऐप्स के अलर्ट पढ़े जाते हैं:',
        'फक्त याच अॅप्सचे अलर्ट वाचले जातात:',
        'শুধুমাত্র এই অ্যাপগুলির অ্যালার্ট পড়া হয়:',
        'ఈ యాప్‌ల అలర్ట్‌లు మాత్రమే చదవబడతాయి:',
        'இந்த ஆப்களின் எச்சரிக்கைகள் மட்டுமே படிக்கப்படும்:',
      );
  String get notifCaptureEverythingElse => _t(
        'Alerts from every other app — messages, mail, anything personal — are ignored on the spot: never stored, never parsed, never seen.',
        'हर दूसरे ऐप के अलर्ट — मैसेज, मेल, कुछ भी निजी — तुरंत अनदेखे होते हैं: न सहेजे जाते हैं, न पढ़े जाते हैं।',
        'इतर प्रत्येक अॅपचे अलर्ट — मेसेज, मेल, काहीही खाजगी — जागीच दुर्लक्षित होतात: कधीही साठवले जात नाहीत, कधीही वाचले जात नाहीत.',
        'অন্য প্রতিটি অ্যাপের অ্যালার্ট — মেসেজ, মেল, ব্যক্তিগত যেকোনো কিছু — সঙ্গে সঙ্গে উপেক্ষিত হয়: কখনো সংরক্ষিত হয় না, কখনো পড়া হয় না।',
        'మిగతా ప్రతి యాప్ అలర్ట్‌లు — మెసేజ్‌లు, మెయిల్, వ్యక్తిగతమైనవేవైనా — అక్కడికక్కడే విస్మరించబడతాయి: ఎప్పుడూ నిల్వ చేయబడవు, ఎప్పుడూ చదవబడవు.',
        'மற்ற எல்லா ஆப்களின் எச்சரிக்கைகள் — செய்திகள், மெயில், தனிப்பட்ட எதுவும் — உடனடியாகப் புறக்கணிக்கப்படும்: ஒருபோதும் சேமிக்கப்படாது, ஒருபோதும் படிக்கப்படாது.',
      );
  String get notifCaptureGrantButton => _t('Grant access', 'एक्सेस दें',
      'अॅक्सेस द्या', 'অ্যাক্সেস দিন', 'యాక్సెస్ ఇవ్వండి', 'அணுகல் வழங்கவும்');
  String get notifCaptureLaterButton => _t('Not now', 'अभी नहीं', 'आत्ता नाही',
      'এখন নয়', 'ఇప్పుడు కాదు', 'இப்போது வேண்டாம்');
  String get notifCaptureOpenSystemSettings => _t(
        'Open system settings',
        'सिस्टम सेटिंग्स खोलें',
        'सिस्टम सेटिंग्ज उघडा',
        'সিস্টেম সেটিংস খুলুন',
        'సిస్టమ్ సెట్టింగ్స్ తెరవండి',
        'சிஸ்டம் அமைப்புகளைத் திறக்கவும்',
      );
  String get notifCaptureDisabledToast => _t(
        'Payment-app capture off. You can also remove Budgetify from notification access in system settings.',
        'पेमेंट-ऐप कैप्चर बंद। सिस्टम सेटिंग्स में जाकर Budgetify का नोटिफ़िकेशन एक्सेस भी हटा सकते हैं।',
        'पेमेंट-अॅप कॅप्चर बंद. सिस्टम सेटिंग्जमध्ये Budgetify चा नोटिफिकेशन अॅक्सेसही काढू शकता.',
        'পেমেন্ট-অ্যাপ ক্যাপচার বন্ধ। সিস্টেম সেটিংসে Budgetify-এর নোটিফিকেশন অ্যাক্সেসও সরাতে পারেন।',
        'పేమెంట్-యాప్ క్యాప్చర్ ఆఫ్. సిస్టమ్ సెట్టింగ్స్‌లో Budgetify నోటిఫికేషన్ యాక్సెస్ కూడా తీసేయవచ్చు.',
        'பேமெண்ட்-ஆப் பதிவு ஆஃப். சிஸ்டம் அமைப்புகளில் Budgetify-இன் அறிவிப்பு அணுகலையும் நீக்கலாம்.',
      );

  // ── Settings · App notification capture · coverage ────────────────────────
  // Which apps are read, and — the part that saves a support question — how
  // much of the user's money each app's alerts can actually account for.
  String get notifCoverageTitle => _t(
        'Which apps are read',
        'कौन-से ऐप पढ़े जाते हैं',
        'कोणते अॅप वाचले जातात',
        'কোন অ্যাপগুলি পড়া হয়',
        'ఏ యాప్‌లు చదవబడతాయి',
        'எந்த ஆப்கள் படிக்கப்படுகின்றன',
      );
  String get notifCoverageSubtitle => _t(
        'The full list, and how much of your money each app can actually account for.',
        'पूरी सूची, और हर ऐप के अलर्ट आपके पैसों का कितना हिसाब रख सकते हैं।',
        'संपूर्ण यादी, आणि प्रत्येक अॅपचे अलर्ट तुमच्या पैशांचा किती हिशेब ठेवू शकतात.',
        'পূর্ণ তালিকা, এবং প্রতিটি অ্যাপের অ্যালার্ট আপনার টাকার কতটা হিসাব রাখতে পারে।',
        'పూర్తి జాబితా, మరియు ప్రతి యాప్ అలర్ట్‌లు మీ డబ్బులో ఎంత లెక్క చూపగలవు.',
        'முழுப் பட்டியல், ஒவ்வொரு ஆப்பின் எச்சரிக்கைகளும் உங்கள் பணத்தில் எவ்வளவு கணக்கு காட்ட முடியும் என்பதுடன்.',
      );
  String get notifCoverageRowDesc => _t(
        'Not every app alerts both ways',
        'हर ऐप दोनों तरफ़ के अलर्ट नहीं देता',
        'प्रत्येक अॅप दोन्ही बाजूंचे अलर्ट देत नाही',
        'সব অ্যাপ দুই দিকেই অ্যালার্ট দেয় না',
        'ప్రతి యాప్ రెండు వైపులా అలర్ట్ ఇవ్వదు',
        'எல்லா ஆப்களும் இரு பக்கமும் எச்சரிக்கை தருவதில்லை',
      );
  String get notifCoverageBothWays => _t(
        'Money out and money in',
        'पैसे जाना और आना, दोनों',
        'पैसे जाणे आणि येणे, दोन्ही',
        'টাকা যাওয়া ও আসা, দুটোই',
        'డబ్బు వెళ్లడం, రావడం — రెండూ',
        'பணம் போவதும் வருவதும், இரண்டும்',
      );
  String get notifCoverageBothWaysNote => _t(
        'Alerts on every payment in both directions, so nothing is missed — even when the bank sends no SMS.',
        'हर भुगतान का अलर्ट देता है, दोनों दिशाओं में — इसलिए कुछ नहीं छूटता, चाहे बैंक SMS न भेजे।',
        'प्रत्येक पेमेंटचा अलर्ट देतो, दोन्ही दिशांना — त्यामुळे काहीही सुटत नाही, बँकेने SMS पाठवला नाही तरी.',
        'প্রতিটি পেমেন্টের অ্যালার্ট দেয়, দুই দিকেই — তাই কিছুই বাদ যায় না, ব্যাংক SMS না পাঠালেও।',
        'ప్రతి చెల్లింపుకూ అలర్ట్ ఇస్తుంది, రెండు దిశల్లోనూ — కాబట్టి బ్యాంక్ SMS పంపకపోయినా ఏదీ మిస్ కాదు.',
        'ஒவ்வொரு பணப்பரிமாற்றத்திற்கும் இரு திசைகளிலும் எச்சரிக்கை தருகிறது — வங்கி SMS அனுப்பாவிட்டாலும் எதுவும் தவறாது.',
      );
  String get notifCoverageCreditsOnly => _t(
        'Money coming in only',
        'सिर्फ़ पैसे आना',
        'फक्त पैसे येणे',
        'শুধু টাকা আসা',
        'డబ్బు రావడం మాత్రమే',
  ...
  String get notifCoverageCreditsOnlyNote => _t(
        'These apps only alert when money arrives. Your own payments are confirmed on a screen inside the app and never posted as an alert, so those spends still come from bank SMS.',
        'ये ऐप सिर्फ़ पैसे आने पर अलर्ट देते हैं। आपके अपने भुगतान की पुष्टि ऐप के अंदर स्क्रीन पर होती है, अलर्ट आता ही नहीं — इसलिए वे खर्च बैंक SMS से ही आते हैं।',
        'हे अॅप फक्त पैसे आल्यावर अलर्ट देतात. तुमच्या स्वतःच्या पेमेंटची पुष्टी अॅपमधील स्क्रीनवर होते, अलर्ट येतच नाही — म्हणून ते खर्च बँक SMS मधूनच येतात.',
        'এই অ্যাপগুলি শুধু টাকা এলে অ্যালার্ট দেয়। আপনার নিজের পেমেন্ট অ্যাপের ভিতরের স্ক্রিনে নিশ্চিত হয়, অ্যালার্ট আসেই না — তাই সেই খরচগুলি ব্যাংক SMS থেকেই আসে।',
        'ఈ యాప్‌లు డబ్బు వచ్చినప్పుడు మాత్రమే అలర్ట్ ఇస్తాయి. మీ సొంత చెల్లింపులు యాప్ లోపలి స్క్రీన్‌లో నిర్ధారించబడతాయి, అలర్ట్ రానే రాదు — కాబట్టి ఆ ఖర్చులు బ్యాంక్ SMS నుండే వస్తాయి.',
        'இந்த ஆப்கள் பணம் வரும்போது மட்டுமே எச்சரிக்கை தரும். உங்கள் சொந்தப் பணப்பரிமாற்றங்கள் ஆப்பினுள் ஒரு திரையில் உறுதிசெய்யப்படும், எச்சரிக்கை வராது — எனவே அந்தச் செலவுகள் வங்கி SMS மூலமே வரும்.',
      );
