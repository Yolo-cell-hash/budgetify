...
class AppStrings {
  ...
  String get royalAppIconDesc => _t(
        'Sets the home-screen icon to your equipped royal (Dark Prince → ruby, Empress → amethyst…). Off by default; a non-royal restores the default icon. Android applies it after a brief app restart.',
        'होम-स्क्रीन आइकन को आपके पहने रॉयल से सेट करता है (डार्क प्रिंस → रूबी, एम्प्रेस → एमेथिस्ट…)। डिफ़ॉल्ट रूप से बंद; गैर-रॉयल पर डिफ़ॉल्ट आइकन लौट आता है। Android इसे थोड़े रीस्टार्ट के बाद लागू करता है।',
        'होम-स्क्रीन आयकन तुमच्या घातलेल्या रॉयलनुसार सेट करतो (डार्क प्रिन्स → रुबी, एम्प्रेस → अ‍ॅमेथिस्ट…). डिफॉल्टनुसार बंद; रॉयल नसल्यास डिफॉल्ट आयकन परत येतो. Android तो थोड्या रीस्टार्टनंतर लागू करतो.',
        'হোম-স্ক্রিন আইকন আপনার পরা রয়্যাল অনুযায়ী সেট করে (ডার্ক প্রিন্স → রুবি, এমপ্রেস → অ্যামেথিস্ট…)। ডিফল্টভাবে বন্ধ; রয়্যাল না হলে ডিফল্ট আইকন ফিরে আসে। Android একটি সংক্ষিপ্ত রিস্টার্টের পরে এটি প্রয়োগ করে।',
        'హోమ్-స్క్రీన్ ఐకాన్‌ను మీరు ధరించిన రాయల్‌కు సెట్ చేస్తుంది (డార్క్ ప్రిన్స్ → రూబీ, ఎంప్రెస్ → అమెథిస్ట్…). డిఫాల్ట్‌గా ఆఫ్; రాయల్ కానిది డిఫాల్ట్ ఐకాన్‌ను తిరిగి తెస్తుంది. Android దీన్ని చిన్న రీస్టార్ట్ తర్వాత వర్తింపజేస్తుంది.',
        'முகப்புத் திரை ஐகானை நீங்கள் அணிந்த ராயலுக்கு அமைக்கும் (டார்க் பிரின்ஸ் → ரூபி, எம்பிரஸ் → அமெதிஸ்ட்…). இயல்பாக அணைப்பு; ராயல் இல்லையெனில் இயல்பு ஐகான் திரும்பும். Android இதை சிறிது மறுதொடக்கத்திற்குப் பிறகு பயன்படுத்தும்.',
      );
